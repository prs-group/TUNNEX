...
*************************************************************************/
class ALG_LIB_DECL  _kdtreerequestbuffer_owner
{
public:
...
class ALG_LIB_DECL  kdtreerequestbuffer : public _kdtreerequestbuffer_owner
{
public:
    kdtreerequestbuffer();
...
KD-tree object.
*************************************************************************/
class ALG_LIB_DECL  _kdtree_owner
{
public:
    _kdtree_owner();
...
class ALG_LIB_DECL  kdtree : public _kdtree_owner
{
public:
    kdtree();
...
*************************************************************************/
class ALG_LIB_DECL  _hqrndstate_owner
{
public:
    _hqrndstate_owner();
...
class ALG_LIB_DECL  hqrndstate : public _hqrndstate_owner
{
public:
    hqrndstate();
...
*************************************************************************/
class ALG_LIB_DECL  _xdebugrecord1_owner
{
public:
...
class ALG_LIB_DECL  xdebugrecord1 : public _xdebugrecord1_owner
{
public:
    xdebugrecord1();
...
* s_out can be freely moved between 32-bit and 64-bit systems, little
  ...
  and vice versa.
*************************************************************************/
ALG_LIB_DECL void kdtreeserialize(kdtree &obj, std::string &s_out);


/*************************************************************************
This function unserializes data structure from string.
*************************************************************************/
ALG_LIB_DECL void kdtreeunserialize(const std::string &s_in, kdtree &obj);
...
*************************************************************************/
ALG_LIB_DECL void kdtreeserialize(kdtree &obj, std::ostream &s_out);


/*************************************************************************
This function unserializes data structure from stream.
*************************************************************************/
ALG_LIB_DECL void kdtreeunserialize(const std::istream &s_in, kdtree &obj);
...
*************************************************************************/
ALG_LIB_DECL void kdtreebuild(const real_2d_array &xy, const ae_int_t n, const ae_int_t nx, const ae_int_t ny, const ae_int_t normtype, kdtree &kdt);
ALG_LIB_DECL void kdtreebuild(const real_2d_array &xy, const ae_int_t nx, const ae_int_t ny, const ae_int_t normtype, kdtree &kdt);
...
2. Although KD-trees may be used with any combination of N  and  NX,  they
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void kdtreebuildtagged(const real_2d_array &xy, const integer_1d_array &tags, const ae_int_t n, const ae_int_t nx, const ae_int_t ny, const ae_int_t normtype, kdtree &kdt);
ALG_LIB_DECL void kdtreebuildtagged(const real_2d_array &xy, const integer_1d_array &tags, const ae_int_t nx, const ae_int_t ny, const ae_int_t normtype, kdtree &kdt);
...
*************************************************************************/
ALG_LIB_DECL void kdtreecreaterequestbuffer(const kdtree &kdt, kdtreerequestbuffer &buf);
...
* KDTreeQueryResultsDistances() to get distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL ae_int_t kdtreequeryknn(const kdtree &kdt, const real_1d_array &x, const ae_int_t k, const bool selfmatch);
ALG_LIB_DECL ae_int_t kdtreequeryknn(const kdtree &kdt, const real_1d_array &x, const ae_int_t k);
...
IMPORTANT: kd-tree buffer should be used only with  KD-tree  object  which
  ...
  -- ALGLIB --
     Copyright 18.03.2016 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL ae_int_t kdtreetsqueryknn(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const ae_int_t k, const bool selfmatch);
ALG_LIB_DECL ae_int_t kdtreetsqueryknn(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const ae_int_t k);
...
* KDTreeQueryResultsDistances() to get distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL ae_int_t kdtreequeryrnn(const kdtree &kdt, const real_1d_array &x, const double r, const bool selfmatch);
ALG_LIB_DECL ae_int_t kdtreequeryrnn(const kdtree &kdt, const real_1d_array &x, const double r);
...
IMPORTANT: kd-tree buffer should be used only with  KD-tree  object  which
  ...
  -- ALGLIB --
     Copyright 18.03.2016 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL ae_int_t kdtreetsqueryrnn(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const double r, const bool selfmatch);
ALG_LIB_DECL ae_int_t kdtreetsqueryrnn(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const double r);
...
* KDTreeQueryResultsDistances() to get distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL ae_int_t kdtreequeryaknn(const kdtree &kdt, const real_1d_array &x, const ae_int_t k, const bool selfmatch, const double eps);
ALG_LIB_DECL ae_int_t kdtreequeryaknn(const kdtree &kdt, const real_1d_array &x, const ae_int_t k, const double eps);
...
IMPORTANT: kd-tree buffer should be used only with  KD-tree  object  which
  ...
  -- ALGLIB --
     Copyright 18.03.2016 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL ae_int_t kdtreetsqueryaknn(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const ae_int_t k, const bool selfmatch, const double eps);
ALG_LIB_DECL ae_int_t kdtreetsqueryaknn(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &x, const ae_int_t k, const double eps);
...
*************************************************************************/
ALG_LIB_DECL ae_int_t kdtreequerybox(const kdtree &kdt, const real_1d_array &boxmin, const real_1d_array &boxmax);
...
IMPORTANT: kd-tree buffer should be used only with  KD-tree  object  which
  ...
  -- ALGLIB --
     Copyright 14.05.2016 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL ae_int_t kdtreetsquerybox(const kdtree &kdt, const kdtreerequestbuffer &buf, const real_1d_array &boxmin, const real_1d_array &boxmax);
...
* KDTreeQueryResultsDistances()     distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void kdtreequeryresultsx(const kdtree &kdt, real_2d_array &x);
...
* KDTreeQueryResultsDistances()     distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void kdtreequeryresultsxy(const kdtree &kdt, real_2d_array &xy);
...
* KDTreeQueryResultsDistances()     distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void kdtreequeryresultstags(const kdtree &kdt, integer_1d_array &tags);
...
* KDTreeQueryResultsTags()          tag values
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void kdtreequeryresultsdistances(const kdtree &kdt, real_1d_array &r);
...
* KDTreeQueryResultsDistances()     distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void kdtreetsqueryresultsx(const kdtree &kdt, const kdtreerequestbuffer &buf, real_2d_array &x);
...
* KDTreeQueryResultsDistances()     distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void kdtreetsqueryresultsxy(const kdtree &kdt, const kdtreerequestbuffer &buf, real_2d_array &xy);
...
* KDTreeQueryResultsDistances()     distances
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void kdtreetsqueryresultstags(const kdtree &kdt, const kdtreerequestbuffer &buf, integer_1d_array &tags);
...
* KDTreeQueryResultsTags()          tag values
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void kdtreetsqueryresultsdistances(const kdtree &kdt, const kdtreerequestbuffer &buf, real_1d_array &r);
...
when you call it from command line.
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void kdtreequeryresultsxi(const kdtree &kdt, real_2d_array &x);
...
when you call it from command line.
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void kdtreequeryresultsxyi(const kdtree &kdt, real_2d_array &xy);
...
when you call it from command line.
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void kdtreequeryresultstagsi(const kdtree &kdt, integer_1d_array &tags);
...
when you call it from command line.
  ...
  -- ALGLIB --
     Copyright 28.02.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void kdtreequeryresultsdistancesi(const kdtree &kdt, real_1d_array &r);
#endif
...
*************************************************************************/
ALG_LIB_DECL void hqrndrandomize(hqrndstate &state);
...
HQRNDState initialization with seed values
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void hqrndseed(const ae_int_t s1, const ae_int_t s2, hqrndstate &state);
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double hqrnduniformr(const hqrndstate &state);
...
2. N can be any positive number except for very large numbers:
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL ae_int_t hqrnduniformi(const hqrndstate &state, const ae_int_t n);
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double hqrndnormal(const hqrndstate &state);
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void hqrndunit2(const hqrndstate &state, double &x, double &y);
...
State structure must be initialized with HQRNDRandomize() or HQRNDSeed().
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void hqrndnormal2(const hqrndstate &state, double &x1, double &x2);
...
*************************************************************************/
ALG_LIB_DECL double hqrndexponential(const hqrndstate &state, const double lambdav);
...
*************************************************************************/
ALG_LIB_DECL double hqrnddiscrete(const hqrndstate &state, const real_1d_array &x, const ae_int_t n);
...
RESULT
  ...
  -- ALGLIB --
     Copyright 08.11.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double hqrndcontinuous(const hqrndstate &state, const real_1d_array &x, const ae_int_t n);
#endif
...
*************************************************************************/
ALG_LIB_DECL void xdebuginitrecord1(xdebugrecord1 &rec1);
...
*************************************************************************/
ALG_LIB_DECL ae_int_t xdebugb1count(const boolean_1d_array &a);
...
Array is passed using "shared" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugb1not(const boolean_1d_array &a);
...
Array is passed using "var" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugb1appendcopy(boolean_1d_array &a);
...
Array is passed using "out" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugb1outeven(const ae_int_t n, boolean_1d_array &a);
...
Returns sum of elements in the array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL ae_int_t xdebugi1sum(const integer_1d_array &a);
...
Array is passed using "shared" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugi1neg(const integer_1d_array &a);
...
Array is passed using "var" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugi1appendcopy(integer_1d_array &a);
...
Array is passed using "out" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugi1outeven(const ae_int_t n, integer_1d_array &a);
...
Returns sum of elements in the array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double xdebugr1sum(const real_1d_array &a);
...
Array is passed using "shared" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugr1neg(const real_1d_array &a);
...
Array is passed using "var" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugr1appendcopy(real_1d_array &a);
...
Array is passed using "out" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugr1outeven(const ae_int_t n, real_1d_array &a);
...
Returns sum of elements in the array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL alglib::complex xdebugc1sum(const complex_1d_array &a);
...
Array is passed using "shared" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugc1neg(const complex_1d_array &a);
...
Array is passed using "var" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugc1appendcopy(complex_1d_array &a);
...
Array is passed using "out" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugc1outeven(const ae_int_t n, complex_1d_array &a);
...
Counts number of True values in the boolean 2D array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL ae_int_t xdebugb2count(const boolean_2d_array &a);
...
Array is passed using "shared" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugb2not(const boolean_2d_array &a);
...
Array is passed using "var" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugb2transpose(boolean_2d_array &a);
...
Array is passed using "out" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugb2outsin(const ae_int_t m, const ae_int_t n, boolean_2d_array &a);
...
Returns sum of elements in the array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL ae_int_t xdebugi2sum(const integer_2d_array &a);
...
Array is passed using "shared" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugi2neg(const integer_2d_array &a);
...
Array is passed using "var" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugi2transpose(integer_2d_array &a);
...
Array is passed using "out" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugi2outsin(const ae_int_t m, const ae_int_t n, integer_2d_array &a);
...
Returns sum of elements in the array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double xdebugr2sum(const real_2d_array &a);
...
Array is passed using "shared" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugr2neg(const real_2d_array &a);
...
Array is passed using "var" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugr2transpose(real_2d_array &a);
...
Array is passed using "out" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugr2outsin(const ae_int_t m, const ae_int_t n, real_2d_array &a);
...
Returns sum of elements in the array.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL alglib::complex xdebugc2sum(const complex_2d_array &a);
...
Array is passed using "shared" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugc2neg(const complex_2d_array &a);
...
Array is passed using "var" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugc2transpose(complex_2d_array &a);
...
Array is passed using "out" convention.
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void xdebugc2outsincos(const ae_int_t m, const ae_int_t n, complex_2d_array &a);
...
Returns sum of a[i,j]*(1+b[i,j]) such that c[i,j] is True
  ...
  -- ALGLIB --
     Copyright 11.10.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double xdebugmaskedbiasedproductsum(const ae_int_t m, const ae_int_t n, const real_2d_array &a, const real_2d_array &b, const boolean_2d_array &c);
#endif
}

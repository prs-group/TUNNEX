...
*************************************************************************/
ALG_LIB_DECL void fftc1d(complex_1d_array &a, const ae_int_t n);
ALG_LIB_DECL void fftc1d(complex_1d_array &a);
...
OUTPUT PARAMETERS
  ...
  -- ALGLIB --
     Copyright 29.05.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void fftc1dinv(complex_1d_array &a, const ae_int_t n);
ALG_LIB_DECL void fftc1dinv(complex_1d_array &a);
...
*************************************************************************/
ALG_LIB_DECL void fftr1d(const real_1d_array &a, const ae_int_t n, complex_1d_array &f);
ALG_LIB_DECL void fftr1d(const real_1d_array &a, complex_1d_array &f);
...
not used) because array size is used to automatically determine FFT length
  ...
  -- ALGLIB --
     Copyright 01.06.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void fftr1dinv(const complex_1d_array &f, const ae_int_t n, real_1d_array &a);
ALG_LIB_DECL void fftr1dinv(const complex_1d_array &f, real_1d_array &a);
#endif
...
*************************************************************************/
ALG_LIB_DECL void fhtr1d(real_1d_array &a, const ae_int_t n);
...
OUTPUT PARAMETERS
  ...
  -- ALGLIB --
     Copyright 29.05.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void fhtr1dinv(real_1d_array &a, const ae_int_t n);
#endif
...
*************************************************************************/
ALG_LIB_DECL void convc1d(const complex_1d_array &a, const ae_int_t m, const complex_1d_array &b, const ae_int_t n, complex_1d_array &r);
...
subroutine - just shift its result correspondingly.
  ...
  -- ALGLIB --
     Copyright 21.07.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void convc1dinv(const complex_1d_array &a, const ae_int_t m, const complex_1d_array &b, const ae_int_t n, complex_1d_array &r);
...
correspondingly.
  ...
  -- ALGLIB --
     Copyright 21.07.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void convc1dcircular(const complex_1d_array &s, const ae_int_t m, const complex_1d_array &r, const ae_int_t n, complex_1d_array &c);
...
correspondingly.
  ...
  -- ALGLIB --
     Copyright 21.07.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void convc1dcircularinv(const complex_1d_array &a, const ae_int_t m, const complex_1d_array &b, const ae_int_t n, complex_1d_array &r);
...
subroutine - just shift its result correspondingly.
  ...
  -- ALGLIB --
     Copyright 21.07.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void convr1d(const real_1d_array &a, const ae_int_t m, const real_1d_array &b, const ae_int_t n, real_1d_array &r);
...
subroutine - just shift its result correspondingly.
  ...
  -- ALGLIB --
     Copyright 21.07.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void convr1dinv(const real_1d_array &a, const ae_int_t m, const real_1d_array &b, const ae_int_t n, real_1d_array &r);
...
correspondingly.
  ...
  -- ALGLIB --
     Copyright 21.07.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void convr1dcircular(const real_1d_array &s, const ae_int_t m, const real_1d_array &r, const ae_int_t n, real_1d_array &c);
...
correspondingly.
  ...
  -- ALGLIB --
     Copyright 21.07.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void convr1dcircularinv(const real_1d_array &a, const ae_int_t m, const real_1d_array &b, const ae_int_t n, real_1d_array &r);
#endif
...
on [-K..M-1],  you can still use this subroutine, just shift result by K.
  ...
  -- ALGLIB --
     Copyright 21.07.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void corrc1d(const complex_1d_array &signal, const ae_int_t n, const complex_1d_array &pattern, const ae_int_t m, complex_1d_array &r);
...
OUTPUT PARAMETERS
  ...
  -- ALGLIB --
     Copyright 21.07.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void corrc1dcircular(const complex_1d_array &signal, const ae_int_t m, const complex_1d_array &pattern, const ae_int_t n, complex_1d_array &c);
...
on [-K..M-1],  you can still use this subroutine, just shift result by K.
  ...
  -- ALGLIB --
     Copyright 21.07.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void corrr1d(const real_1d_array &signal, const ae_int_t n, const real_1d_array &pattern, const ae_int_t m, real_1d_array &r);
...
OUTPUT PARAMETERS
  ...
  -- ALGLIB --
     Copyright 21.07.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void corrr1dcircular(const real_1d_array &signal, const ae_int_t m, const real_1d_array &pattern, const ae_int_t n, real_1d_array &c);
#endif
}

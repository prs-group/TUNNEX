...
IDW interpolant.
*************************************************************************/
class ALG_LIB_DECL  _idwinterpolant_owner
{
public:
...
class ALG_LIB_DECL  idwinterpolant : public _idwinterpolant_owner
{
public:
    idwinterpolant();
...
*************************************************************************/
class ALG_LIB_DECL  _barycentricinterpolant_owner
{
public:
...
class ALG_LIB_DECL  barycentricinterpolant : public _barycentricinterpolant_owner
{
public:
    barycentricinterpolant();
...
*************************************************************************/
class ALG_LIB_DECL  _spline1dinterpolant_owner
{
public:
...
class ALG_LIB_DECL  spline1dinterpolant : public _spline1dinterpolant_owner
{
public:
    spline1dinterpolant();
...
*************************************************************************/
class ALG_LIB_DECL  _spline1dfitreport_owner
{
public:
...
class ALG_LIB_DECL  spline1dfitreport : public _spline1dfitreport_owner
{
public:
    spline1dfitreport();
...
functions instead.
*************************************************************************/
class ALG_LIB_DECL  _pspline2interpolant_owner
{
public:
...
class ALG_LIB_DECL  pspline2interpolant : public _pspline2interpolant_owner
{
public:
    pspline2interpolant();
...
functions instead.
*************************************************************************/
class ALG_LIB_DECL  _pspline3interpolant_owner
{
public:
...
class ALG_LIB_DECL  pspline3interpolant : public _pspline3interpolant_owner
{
public:
    pspline3interpolant();
...
*************************************************************************/
class ALG_LIB_DECL  _spline3dinterpolant_owner
{
public:
...
class ALG_LIB_DECL  spline3dinterpolant : public _spline3dinterpolant_owner
{
public:
    spline3dinterpolant();
...
Polynomial fitting report:
    ...
    MaxError        maximum error
*************************************************************************/
class ALG_LIB_DECL  _polynomialfitreport_owner
{
public:
...
class ALG_LIB_DECL  polynomialfitreport : public _polynomialfitreport_owner
{
public:
    polynomialfitreport();
...
Barycentric fitting report:
    ...
    TaskRCond       reciprocal of task's condition number
*************************************************************************/
class ALG_LIB_DECL  _barycentricfitreport_owner
{
public:
...
class ALG_LIB_DECL  barycentricfitreport : public _barycentricfitreport_owner
{
public:
    barycentricfitreport();
...
*************************************************************************/
class ALG_LIB_DECL  _lsfitreport_owner
{
public:
    _lsfitreport_owner();
...
class ALG_LIB_DECL  lsfitreport : public _lsfitreport_owner
{
public:
    lsfitreport();
...
*************************************************************************/
class ALG_LIB_DECL  _lsfitstate_owner
{
public:
    _lsfitstate_owner();
...
class ALG_LIB_DECL  lsfitstate : public _lsfitstate_owner
{
public:
    lsfitstate();
...
*************************************************************************/
class ALG_LIB_DECL  _spline2dinterpolant_owner
{
public:
...
class ALG_LIB_DECL  spline2dinterpolant : public _spline2dinterpolant_owner
{
public:
    spline2dinterpolant();
...
*************************************************************************/
class ALG_LIB_DECL  _rbfcalcbuffer_owner
{
public:
...
class ALG_LIB_DECL  rbfcalcbuffer : public _rbfcalcbuffer_owner
{
public:
    rbfcalcbuffer();
...
*************************************************************************/
class ALG_LIB_DECL  _rbfmodel_owner
{
public:
    _rbfmodel_owner();
...
class ALG_LIB_DECL  rbfmodel : public _rbfmodel_owner
{
public:
    rbfmodel();
...
*************************************************************************/
class ALG_LIB_DECL  _rbfreport_owner
{
public:
    _rbfreport_owner();
...
class ALG_LIB_DECL  rbfreport : public _rbfreport_owner
{
public:
    rbfreport();
...
*************************************************************************/
ALG_LIB_DECL double idwcalc(const idwinterpolant &z, const real_1d_array &x);
...
NOTES:
  ...
  * this subroutine assumes that point distribution is uniform at the small
  ...
  -- ALGLIB PROJECT --
     Copyright 02.03.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void idwbuildmodifiedshepard(const real_2d_array &xy, const ae_int_t n, const ae_int_t nx, const ae_int_t d, const ae_int_t nq, const ae_int_t nw, idwinterpolant &z);
...
*************************************************************************/
ALG_LIB_DECL void idwbuildmodifiedshepardr(const real_2d_array &xy, const ae_int_t n, const ae_int_t nx, const double r, idwinterpolant &z);
...
NOTES:
  ...
  * see  'Multivariate  Interpolation  of Large Sets of Scattered Data' by
  ...
  -- ALGLIB PROJECT --
     Copyright 02.03.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void idwbuildnoisy(const real_2d_array &xy, const ae_int_t n, const ae_int_t nx, const ae_int_t d, const ae_int_t nq, const ae_int_t nw, idwinterpolant &z);
#endif
...
*************************************************************************/
ALG_LIB_DECL double barycentriccalc(const barycentricinterpolant &b, const double t);
...
NOTE
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void barycentricdiff1(const barycentricinterpolant &b, const double t, double &f, double &df);
...
BarycentricDiff1() subroutine in such cases.
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void barycentricdiff2(const barycentricinterpolant &b, const double t, double &f, double &df, double &d2f);
...
*************************************************************************/
ALG_LIB_DECL void barycentriclintransx(const barycentricinterpolant &b, const double ca, const double cb);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 19.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void barycentriclintransy(const barycentricinterpolant &b, const double ca, const double cb);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void barycentricunpack(const barycentricinterpolant &b, ae_int_t &n, real_1d_array &x, real_1d_array &y, real_1d_array &w);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void barycentricbuildxyw(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t n, barycentricinterpolant &b);
...
*************************************************************************/
ALG_LIB_DECL void barycentricbuildfloaterhormann(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t d, barycentricinterpolant &b);
#endif
...
*************************************************************************/
ALG_LIB_DECL void spline1dbuildlinear(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, spline1dinterpolant &c);
ALG_LIB_DECL void spline1dbuildlinear(const real_1d_array &x, const real_1d_array &y, spline1dinterpolant &c);
...
*************************************************************************/
ALG_LIB_DECL void spline1dbuildcubic(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t boundltype, const double boundl, const ae_int_t boundrtype, const double boundr, spline1dinterpolant &c);
ALG_LIB_DECL void spline1dbuildcubic(const real_1d_array &x, const real_1d_array &y, spline1dinterpolant &c);
...
*************************************************************************/
ALG_LIB_DECL void spline1dgriddiffcubic(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t boundltype, const double boundl, const ae_int_t boundrtype, const double boundr, real_1d_array &d);
ALG_LIB_DECL void spline1dgriddiffcubic(const real_1d_array &x, const real_1d_array &y, real_1d_array &d);
...
i.e. to make Y[first_point]=Y[last_point].
  ...
  -- ALGLIB PROJECT --
     Copyright 03.09.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline1dgriddiff2cubic(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t boundltype, const double boundl, const ae_int_t boundrtype, const double boundr, real_1d_array &d1, real_1d_array &d2);
ALG_LIB_DECL void spline1dgriddiff2cubic(const real_1d_array &x, const real_1d_array &y, real_1d_array &d1, real_1d_array &d2);
...
i.e. to make Y[first_point]=Y[last_point].
  ...
  -- ALGLIB PROJECT --
     Copyright 03.09.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline1dconvcubic(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t boundltype, const double boundl, const ae_int_t boundrtype, const double boundr, const real_1d_array &x2, const ae_int_t n2, real_1d_array &y2);
ALG_LIB_DECL void spline1dconvcubic(const real_1d_array &x, const real_1d_array &y, const real_1d_array &x2, real_1d_array &y2);
...
i.e. to make Y[first_point]=Y[last_point].
  ...
  -- ALGLIB PROJECT --
     Copyright 03.09.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline1dconvdiffcubic(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t boundltype, const double boundl, const ae_int_t boundrtype, const double boundr, const real_1d_array &x2, const ae_int_t n2, real_1d_array &y2, real_1d_array &d2);
ALG_LIB_DECL void spline1dconvdiffcubic(const real_1d_array &x, const real_1d_array &y, const real_1d_array &x2, real_1d_array &y2, real_1d_array &d2);
...
i.e. to make Y[first_point]=Y[last_point].
  ...
  -- ALGLIB PROJECT --
     Copyright 03.09.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline1dconvdiff2cubic(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t boundltype, const double boundl, const ae_int_t boundrtype, const double boundr, const real_1d_array &x2, const ae_int_t n2, real_1d_array &y2, real_1d_array &d2, real_1d_array &dd2);
ALG_LIB_DECL void spline1dconvdiff2cubic(const real_1d_array &x, const real_1d_array &y, const real_1d_array &x2, real_1d_array &y2, real_1d_array &d2, real_1d_array &dd2);
...
i.e. to make Y[first_point]=Y[last_point].
  ...
  -- ALGLIB PROJECT --
     Copyright 23.06.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline1dbuildcatmullrom(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t boundtype, const double tension, spline1dinterpolant &c);
ALG_LIB_DECL void spline1dbuildcatmullrom(const real_1d_array &x, const real_1d_array &y, spline1dinterpolant &c);
...
Subroutine automatically sorts points, so caller may pass unsorted array.
  ...
  -- ALGLIB PROJECT --
     Copyright 23.06.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline1dbuildhermite(const real_1d_array &x, const real_1d_array &y, const real_1d_array &d, const ae_int_t n, spline1dinterpolant &c);
ALG_LIB_DECL void spline1dbuildhermite(const real_1d_array &x, const real_1d_array &y, const real_1d_array &d, spline1dinterpolant &c);
...
Subroutine automatically sorts points, so caller may pass unsorted array.
  ...
  -- ALGLIB PROJECT --
     Copyright 24.06.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline1dbuildakima(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, spline1dinterpolant &c);
ALG_LIB_DECL void spline1dbuildakima(const real_1d_array &x, const real_1d_array &y, spline1dinterpolant &c);
...
Result:
  ...
  -- ALGLIB PROJECT --
     Copyright 23.06.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double spline1dcalc(const spline1dinterpolant &c, const double x);
...
Result:
  ...
  -- ALGLIB PROJECT --
     Copyright 24.06.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline1ddiff(const spline1dinterpolant &c, const double x, double &s, double &ds, double &d2s);
...
*************************************************************************/
ALG_LIB_DECL void spline1dunpack(const spline1dinterpolant &c, ae_int_t &n, real_2d_array &tbl);
...
*************************************************************************/
ALG_LIB_DECL void spline1dlintransx(const spline1dinterpolant &c, const double a, const double b);
...
Result:
  ...
  -- ALGLIB PROJECT --
     Copyright 30.06.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline1dlintransy(const spline1dinterpolant &c, const double a, const double b);
...
Result:
  ...
  -- ALGLIB PROJECT --
     Copyright 23.06.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double spline1dintegrate(const spline1dinterpolant &c, const double x);
...
*************************************************************************/
ALG_LIB_DECL void spline1dfitpenalized(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t m, const double rho, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void smp_spline1dfitpenalized(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t m, const double rho, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void spline1dfitpenalized(const real_1d_array &x, const real_1d_array &y, const ae_int_t m, const double rho, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void smp_spline1dfitpenalized(const real_1d_array &x, const real_1d_array &y, const ae_int_t m, const double rho, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
...
*************************************************************************/
ALG_LIB_DECL void spline1dfitpenalizedw(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t n, const ae_int_t m, const double rho, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void smp_spline1dfitpenalizedw(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t n, const ae_int_t m, const double rho, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void spline1dfitpenalizedw(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t m, const double rho, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void smp_spline1dfitpenalizedw(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t m, const double rho, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
...
*************************************************************************/
ALG_LIB_DECL void spline1dbuildmonotone(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, spline1dinterpolant &c);
ALG_LIB_DECL void spline1dbuildmonotone(const real_1d_array &x, const real_1d_array &y, spline1dinterpolant &c);
#endif
...
*************************************************************************/
ALG_LIB_DECL void pspline2build(const real_2d_array &xy, const ae_int_t n, const ae_int_t st, const ae_int_t pt, pspline2interpolant &p);
...
description here.
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void pspline3build(const real_2d_array &xy, const ae_int_t n, const ae_int_t st, const ae_int_t pt, pspline3interpolant &p);
...
* last point of sequence is NOT equal to the first  point.  You  shouldn't
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void pspline2buildperiodic(const real_2d_array &xy, const ae_int_t n, const ae_int_t st, const ae_int_t pt, pspline2interpolant &p);
...
description here.
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void pspline3buildperiodic(const real_2d_array &xy, const ae_int_t n, const ae_int_t st, const ae_int_t pt, pspline3interpolant &p);
...
* for periodic splines     U[0]=0, U[0]<U[1]<...<U[N-1], U[N-1]<1
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void pspline2parametervalues(const pspline2interpolant &p, ae_int_t &n, real_1d_array &t);
...
Same as PSpline2ParameterValues(), but for 3D.
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void pspline3parametervalues(const pspline3interpolant &p, ae_int_t &n, real_1d_array &t);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void pspline2calc(const pspline2interpolant &p, const double t, double &x, double &y);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void pspline3calc(const pspline3interpolant &p, const double t, double &x, double &y, double &z);
...
NOTE:
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void pspline2tangent(const pspline2interpolant &p, const double t, double &x, double &y);
...
NOTE:
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void pspline3tangent(const pspline3interpolant &p, const double t, double &x, double &y, double &z);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void pspline2diff(const pspline2interpolant &p, const double t, double &x, double &dx, double &y, double &dy);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void pspline3diff(const pspline3interpolant &p, const double t, double &x, double &dx, double &y, double &dy, double &z, double &dz);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void pspline2diff2(const pspline2interpolant &p, const double t, double &x, double &dx, double &d2x, double &y, double &dy, double &d2y);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 28.05.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void pspline3diff2(const pspline3interpolant &p, const double t, double &x, double &dx, double &d2x, double &y, double &dy, double &d2y, double &z, double &dz, double &d2z);
...
*************************************************************************/
ALG_LIB_DECL double pspline2arclength(const pspline2interpolant &p, const double a, const double b);
...
RESULT:
  ...
  -- ALGLIB PROJECT --
     Copyright 30.05.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double pspline3arclength(const pspline3interpolant &p, const double a, const double b);
...
*************************************************************************/
ALG_LIB_DECL void parametricrdpfixed(const real_2d_array &x, const ae_int_t n, const ae_int_t d, const ae_int_t stopm, const double stopeps, real_2d_array &x2, integer_1d_array &idx2, ae_int_t &nsections);
#endif
...
*************************************************************************/
ALG_LIB_DECL double spline3dcalc(const spline3dinterpolant &c, const double x, const double y, const double z);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 26.04.2012 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline3dlintransxyz(const spline3dinterpolant &c, const double ax, const double bx, const double ay, const double by, const double az, const double bz);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 26.04.2012 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline3dlintransf(const spline3dinterpolant &c, const double a, const double b);
...
*************************************************************************/
ALG_LIB_DECL void spline3dresampletrilinear(const real_1d_array &a, const ae_int_t oldzcount, const ae_int_t oldycount, const ae_int_t oldxcount, const ae_int_t newzcount, const ae_int_t newycount, const ae_int_t newxcount, real_1d_array &b);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 26.04.2012 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline3dbuildtrilinearv(const real_1d_array &x, const ae_int_t n, const real_1d_array &y, const ae_int_t m, const real_1d_array &z, const ae_int_t l, const real_1d_array &f, const ae_int_t d, spline3dinterpolant &c);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 26.04.2012 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline3dcalcvbuf(const spline3dinterpolant &c, const double x, const double y, const double z, real_1d_array &f);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 26.04.2012 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline3dcalcv(const spline3dinterpolant &c, const double x, const double y, const double z, real_1d_array &f);
...
Result:
  ...
  -- ALGLIB PROJECT --
     Copyright 26.04.2012 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline3dunpackv(const spline3dinterpolant &c, ae_int_t &n, ae_int_t &m, ae_int_t &l, ae_int_t &d, ae_int_t &stype, real_2d_array &tbl);
#endif
...
*************************************************************************/
ALG_LIB_DECL void polynomialbar2cheb(const barycentricinterpolant &p, const double a, const double b, real_1d_array &t);
...
OUTPUT PARAMETERS
  ...
  -- ALGLIB --
     Copyright 30.09.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void polynomialcheb2bar(const real_1d_array &t, const ae_int_t n, const double a, const double b, barycentricinterpolant &p);
ALG_LIB_DECL void polynomialcheb2bar(const real_1d_array &t, const double a, const double b, barycentricinterpolant &p);
...
3.  barycentric interpolant passed as P may be either polynomial  obtained
  ...
  -- ALGLIB --
     Copyright 30.09.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void polynomialbar2pow(const barycentricinterpolant &p, const double c, const double s, real_1d_array &a);
ALG_LIB_DECL void polynomialbar2pow(const barycentricinterpolant &p, real_1d_array &a);
...
2.  power basis is ill-conditioned and tricks described above can't  solve
  ...
  -- ALGLIB --
     Copyright 30.09.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void polynomialpow2bar(const real_1d_array &a, const ae_int_t n, const double c, const double s, barycentricinterpolant &p);
ALG_LIB_DECL void polynomialpow2bar(const real_1d_array &a, barycentricinterpolant &p);
...
*************************************************************************/
ALG_LIB_DECL void polynomialbuild(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, barycentricinterpolant &p);
ALG_LIB_DECL void polynomialbuild(const real_1d_array &x, const real_1d_array &y, barycentricinterpolant &p);
...
*************************************************************************/
ALG_LIB_DECL void polynomialbuildeqdist(const double a, const double b, const real_1d_array &y, const ae_int_t n, barycentricinterpolant &p);
ALG_LIB_DECL void polynomialbuildeqdist(const double a, const double b, const real_1d_array &y, barycentricinterpolant &p);
...
OUTPUT PARAMETERS
  ...
  -- ALGLIB --
     Copyright 03.12.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void polynomialbuildcheb1(const double a, const double b, const real_1d_array &y, const ae_int_t n, barycentricinterpolant &p);
ALG_LIB_DECL void polynomialbuildcheb1(const double a, const double b, const real_1d_array &y, barycentricinterpolant &p);
...
OUTPUT PARAMETERS
  ...
  -- ALGLIB --
     Copyright 03.12.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void polynomialbuildcheb2(const double a, const double b, const real_1d_array &y, const ae_int_t n, barycentricinterpolant &p);
ALG_LIB_DECL void polynomialbuildcheb2(const double a, const double b, const real_1d_array &y, barycentricinterpolant &p);
...
IMPORTANT
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double polynomialcalceqdist(const double a, const double b, const real_1d_array &f, const ae_int_t n, const double t);
ALG_LIB_DECL double polynomialcalceqdist(const double a, const double b, const real_1d_array &f, const double t);
...
IMPORTANT
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double polynomialcalccheb1(const double a, const double b, const real_1d_array &f, const ae_int_t n, const double t);
ALG_LIB_DECL double polynomialcalccheb1(const double a, const double b, const real_1d_array &f, const double t);
...
IMPORTANT
  ...
  -- ALGLIB --
     Copyright 02.12.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double polynomialcalccheb2(const double a, const double b, const real_1d_array &f, const ae_int_t n, const double t);
ALG_LIB_DECL double polynomialcalccheb2(const double a, const double b, const real_1d_array &f, const double t);
#endif
...
NOTE: X2/Y2 are ordered arrays, i.e. (X2[0],Y2[0]) is  a  first  point  of
  ...
  -- ALGLIB --
     Copyright 02.10.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void lstfitpiecewiselinearrdpfixed(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t m, real_1d_array &x2, real_1d_array &y2, ae_int_t &nsections);
...
NOTE: X2/Y2 are ordered arrays, i.e. (X2[0],Y2[0]) is  a  first  point  of
  ...
  -- ALGLIB --
     Copyright 02.10.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void lstfitpiecewiselinearrdp(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const double eps, real_1d_array &x2, real_1d_array &y2, ae_int_t &nsections);
...
*************************************************************************/
ALG_LIB_DECL void polynomialfit(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t m, ae_int_t &info, barycentricinterpolant &p, polynomialfitreport &rep);
ALG_LIB_DECL void smp_polynomialfit(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t m, ae_int_t &info, barycentricinterpolant &p, polynomialfitreport &rep);
ALG_LIB_DECL void polynomialfit(const real_1d_array &x, const real_1d_array &y, const ae_int_t m, ae_int_t &info, barycentricinterpolant &p, polynomialfitreport &rep);
ALG_LIB_DECL void smp_polynomialfit(const real_1d_array &x, const real_1d_array &y, const ae_int_t m, ae_int_t &info, barycentricinterpolant &p, polynomialfitreport &rep);
...
above is not guaranteed and may result in inconsistency.
  ...
  -- ALGLIB PROJECT --
     Copyright 10.12.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void polynomialfitwc(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t n, const real_1d_array &xc, const real_1d_array &yc, const integer_1d_array &dc, const ae_int_t k, const ae_int_t m, ae_int_t &info, barycentricinterpolant &p, polynomialfitreport &rep);
ALG_LIB_DECL void smp_polynomialfitwc(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t n, const real_1d_array &xc, const real_1d_array &yc, const integer_1d_array &dc, const ae_int_t k, const ae_int_t m, ae_int_t &info, barycentricinterpolant &p, polynomialfitreport &rep);
ALG_LIB_DECL void polynomialfitwc(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const real_1d_array &xc, const real_1d_array &yc, const integer_1d_array &dc, const ae_int_t m, ae_int_t &info, barycentricinterpolant &p, polynomialfitreport &rep);
ALG_LIB_DECL void smp_polynomialfitwc(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const real_1d_array &xc, const real_1d_array &yc, const integer_1d_array &dc, const ae_int_t m, ae_int_t &info, barycentricinterpolant &p, polynomialfitreport &rep);
...
*************************************************************************/
ALG_LIB_DECL double logisticcalc4(const double x, const double a, const double b, const double c, const double d);
...
NOTE: this function performs a lot of checks;  if  you  need  really  high
  ...
  -- ALGLIB PROJECT --
     Copyright 14.05.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double logisticcalc5(const double x, const double a, const double b, const double c, const double d, const double g);
...
*************************************************************************/
ALG_LIB_DECL void logisticfit4(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, double &a, double &b, double &c, double &d, lsfitreport &rep);
...
D. That's because 4PL model is normalized in such way that B>=0.
  ...
  -- ALGLIB PROJECT --
     Copyright 14.02.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void logisticfit4ec(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const double cnstrleft, const double cnstrright, double &a, double &b, double &c, double &d, lsfitreport &rep);
...
NOTE: step is automatically scaled according to scale of parameters  being
  ...
  -- ALGLIB PROJECT --
     Copyright 14.02.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void logisticfit5(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, double &a, double &b, double &c, double &d, double &g, lsfitreport &rep);
...
question highlighted above is important when you interpret fitting results.
  ...
  -- ALGLIB PROJECT --
     Copyright 14.02.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void logisticfit5ec(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const double cnstrleft, const double cnstrright, double &a, double &b, double &c, double &d, double &g, lsfitreport &rep);
...
question highlighted above is important when you interpret fitting results.
  ...
  -- ALGLIB PROJECT --
     Copyright 14.02.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void logisticfit45x(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const double cnstrleft, const double cnstrright, const bool is4pl, const double lambdav, const double epsx, const ae_int_t rscnt, double &a, double &b, double &c, double &d, double &g, lsfitreport &rep);
...
above is not guaranteed and may result in inconsistency.
  ...
  -- ALGLIB PROJECT --
     Copyright 18.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void barycentricfitfloaterhormannwc(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t n, const real_1d_array &xc, const real_1d_array &yc, const integer_1d_array &dc, const ae_int_t k, const ae_int_t m, ae_int_t &info, barycentricinterpolant &b, barycentricfitreport &rep);
ALG_LIB_DECL void smp_barycentricfitfloaterhormannwc(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t n, const real_1d_array &xc, const real_1d_array &yc, const integer_1d_array &dc, const ae_int_t k, const ae_int_t m, ae_int_t &info, barycentricinterpolant &b, barycentricfitreport &rep);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 18.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void barycentricfitfloaterhormann(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t m, ae_int_t &info, barycentricinterpolant &b, barycentricfitreport &rep);
ALG_LIB_DECL void smp_barycentricfitfloaterhormann(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t m, ae_int_t &info, barycentricinterpolant &b, barycentricfitreport &rep);
...
above is not guaranteed and may result in inconsistency.
  ...
  -- ALGLIB PROJECT --
     Copyright 18.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline1dfitcubicwc(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t n, const real_1d_array &xc, const real_1d_array &yc, const integer_1d_array &dc, const ae_int_t k, const ae_int_t m, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void smp_spline1dfitcubicwc(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t n, const real_1d_array &xc, const real_1d_array &yc, const integer_1d_array &dc, const ae_int_t k, const ae_int_t m, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void spline1dfitcubicwc(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const real_1d_array &xc, const real_1d_array &yc, const integer_1d_array &dc, const ae_int_t m, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void smp_spline1dfitcubicwc(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const real_1d_array &xc, const real_1d_array &yc, const integer_1d_array &dc, const ae_int_t m, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
...
above is not guaranteed and may result in inconsistency.
  ...
  -- ALGLIB PROJECT --
     Copyright 18.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline1dfithermitewc(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t n, const real_1d_array &xc, const real_1d_array &yc, const integer_1d_array &dc, const ae_int_t k, const ae_int_t m, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void smp_spline1dfithermitewc(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const ae_int_t n, const real_1d_array &xc, const real_1d_array &yc, const integer_1d_array &dc, const ae_int_t k, const ae_int_t m, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void spline1dfithermitewc(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const real_1d_array &xc, const real_1d_array &yc, const integer_1d_array &dc, const ae_int_t m, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void smp_spline1dfithermitewc(const real_1d_array &x, const real_1d_array &y, const real_1d_array &w, const real_1d_array &xc, const real_1d_array &yc, const integer_1d_array &dc, const ae_int_t m, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
...
COMMERCIAL EDITION OF ALGLIB:
  ...
  -- ALGLIB PROJECT --
     Copyright 18.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline1dfitcubic(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t m, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void smp_spline1dfitcubic(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t m, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void spline1dfitcubic(const real_1d_array &x, const real_1d_array &y, const ae_int_t m, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void smp_spline1dfitcubic(const real_1d_array &x, const real_1d_array &y, const ae_int_t m, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
...
COMMERCIAL EDITION OF ALGLIB:
  ...
  -- ALGLIB PROJECT --
     Copyright 18.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline1dfithermite(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t m, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void smp_spline1dfithermite(const real_1d_array &x, const real_1d_array &y, const ae_int_t n, const ae_int_t m, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void spline1dfithermite(const real_1d_array &x, const real_1d_array &y, const ae_int_t m, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
ALG_LIB_DECL void smp_spline1dfithermite(const real_1d_array &x, const real_1d_array &y, const ae_int_t m, ae_int_t &info, spline1dinterpolant &s, spline1dfitreport &rep);
...
NOTE:       covariance matrix is estimated using  correction  for  degrees
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void lsfitlinearw(const real_1d_array &y, const real_1d_array &w, const real_2d_array &fmatrix, const ae_int_t n, const ae_int_t m, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
ALG_LIB_DECL void smp_lsfitlinearw(const real_1d_array &y, const real_1d_array &w, const real_2d_array &fmatrix, const ae_int_t n, const ae_int_t m, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
ALG_LIB_DECL void lsfitlinearw(const real_1d_array &y, const real_1d_array &w, const real_2d_array &fmatrix, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
ALG_LIB_DECL void smp_lsfitlinearw(const real_1d_array &y, const real_1d_array &w, const real_2d_array &fmatrix, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
...
*************************************************************************/
ALG_LIB_DECL void lsfitlinearwc(const real_1d_array &y, const real_1d_array &w, const real_2d_array &fmatrix, const real_2d_array &cmatrix, const ae_int_t n, const ae_int_t m, const ae_int_t k, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
ALG_LIB_DECL void smp_lsfitlinearwc(const real_1d_array &y, const real_1d_array &w, const real_2d_array &fmatrix, const real_2d_array &cmatrix, const ae_int_t n, const ae_int_t m, const ae_int_t k, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
ALG_LIB_DECL void lsfitlinearwc(const real_1d_array &y, const real_1d_array &w, const real_2d_array &fmatrix, const real_2d_array &cmatrix, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
ALG_LIB_DECL void smp_lsfitlinearwc(const real_1d_array &y, const real_1d_array &w, const real_2d_array &fmatrix, const real_2d_array &cmatrix, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
...
NOTE:       covariance matrix is estimated using  correction  for  degrees
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void lsfitlinear(const real_1d_array &y, const real_2d_array &fmatrix, const ae_int_t n, const ae_int_t m, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
ALG_LIB_DECL void smp_lsfitlinear(const real_1d_array &y, const real_2d_array &fmatrix, const ae_int_t n, const ae_int_t m, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
ALG_LIB_DECL void lsfitlinear(const real_1d_array &y, const real_2d_array &fmatrix, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
ALG_LIB_DECL void smp_lsfitlinear(const real_1d_array &y, const real_2d_array &fmatrix, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
...
NOTE:       covariance matrix is estimated using  correction  for  degrees
  ...
  -- ALGLIB --
     Copyright 07.09.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void lsfitlinearc(const real_1d_array &y, const real_2d_array &fmatrix, const real_2d_array &cmatrix, const ae_int_t n, const ae_int_t m, const ae_int_t k, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
ALG_LIB_DECL void smp_lsfitlinearc(const real_1d_array &y, const real_2d_array &fmatrix, const real_2d_array &cmatrix, const ae_int_t n, const ae_int_t m, const ae_int_t k, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
ALG_LIB_DECL void lsfitlinearc(const real_1d_array &y, const real_2d_array &fmatrix, const real_2d_array &cmatrix, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
ALG_LIB_DECL void smp_lsfitlinearc(const real_1d_array &y, const real_2d_array &fmatrix, const real_2d_array &cmatrix, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
...
*************************************************************************/
ALG_LIB_DECL void lsfitcreatewf(const real_2d_array &x, const real_1d_array &y, const real_1d_array &w, const real_1d_array &c, const ae_int_t n, const ae_int_t m, const ae_int_t k, const double diffstep, lsfitstate &state);
ALG_LIB_DECL void lsfitcreatewf(const real_2d_array &x, const real_1d_array &y, const real_1d_array &w, const real_1d_array &c, const double diffstep, lsfitstate &state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 18.10.2008 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void lsfitcreatef(const real_2d_array &x, const real_1d_array &y, const real_1d_array &c, const ae_int_t n, const ae_int_t m, const ae_int_t k, const double diffstep, lsfitstate &state);
ALG_LIB_DECL void lsfitcreatef(const real_2d_array &x, const real_1d_array &y, const real_1d_array &c, const double diffstep, lsfitstate &state);
...
See also:
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void lsfitcreatewfg(const real_2d_array &x, const real_1d_array &y, const real_1d_array &w, const real_1d_array &c, const ae_int_t n, const ae_int_t m, const ae_int_t k, const bool cheapfg, lsfitstate &state);
ALG_LIB_DECL void lsfitcreatewfg(const real_2d_array &x, const real_1d_array &y, const real_1d_array &w, const real_1d_array &c, const bool cheapfg, lsfitstate &state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void lsfitcreatefg(const real_2d_array &x, const real_1d_array &y, const real_1d_array &c, const ae_int_t n, const ae_int_t m, const ae_int_t k, const bool cheapfg, lsfitstate &state);
ALG_LIB_DECL void lsfitcreatefg(const real_2d_array &x, const real_1d_array &y, const real_1d_array &c, const bool cheapfg, lsfitstate &state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void lsfitcreatewfgh(const real_2d_array &x, const real_1d_array &y, const real_1d_array &w, const real_1d_array &c, const ae_int_t n, const ae_int_t m, const ae_int_t k, lsfitstate &state);
ALG_LIB_DECL void lsfitcreatewfgh(const real_2d_array &x, const real_1d_array &y, const real_1d_array &w, const real_1d_array &c, lsfitstate &state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void lsfitcreatefgh(const real_2d_array &x, const real_1d_array &y, const real_1d_array &c, const ae_int_t n, const ae_int_t m, const ae_int_t k, lsfitstate &state);
ALG_LIB_DECL void lsfitcreatefgh(const real_2d_array &x, const real_1d_array &y, const real_1d_array &c, lsfitstate &state);
...
stopping criterion selection (according to the scheme used by MINLM unit).
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void lsfitsetcond(const lsfitstate &state, const double epsx, const ae_int_t maxits);
...
*************************************************************************/
ALG_LIB_DECL void lsfitsetstpmax(const lsfitstate &state, const double stpmax);
...
*************************************************************************/
ALG_LIB_DECL void lsfitsetxrep(const lsfitstate &state, const bool needxrep);
...
*************************************************************************/
ALG_LIB_DECL void lsfitsetscale(const lsfitstate &state, const real_1d_array &s);
...
* function is evaluated only INSIDE area specified by bound constraints
  ...
  -- ALGLIB --
     Copyright 14.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void lsfitsetbc(const lsfitstate &state, const real_1d_array &bndl, const real_1d_array &bndu);
...
*************************************************************************/
ALG_LIB_DECL void lsfitsetlc(const lsfitstate &state, const real_2d_array &c, const integer_1d_array &ct, const ae_int_t k);
ALG_LIB_DECL void lsfitsetlc(const lsfitstate &state, const real_2d_array &c, const integer_1d_array &ct);
...
*************************************************************************/
ALG_LIB_DECL bool lsfititeration(const lsfitstate &state);
...
NOTE:       covariance matrix is estimated using  correction  for  degrees
  ...
  -- ALGLIB --
     Copyright 17.08.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void lsfitresults(const lsfitstate &state, ae_int_t &info, real_1d_array &c, lsfitreport &rep);
...
*************************************************************************/
ALG_LIB_DECL void lsfitsetgradientcheck(const lsfitstate &state, const double teststep);
#endif
...
*************************************************************************/
ALG_LIB_DECL void nsfitspheremcc(const real_2d_array &xy, const ae_int_t npoints, const ae_int_t nx, real_1d_array &cx, double &rhi);
...
NOTE: this function is an easy-to-use wrapper around more powerful "expert"
  ...
  -- ALGLIB --
     Copyright 14.04.2017 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void nsfitspheremic(const real_2d_array &xy, const ae_int_t npoints, const ae_int_t nx, real_1d_array &cx, double &rlo);
...
NOTE: this function is an easy-to-use wrapper around more powerful "expert"
  ...
  -- ALGLIB --
     Copyright 14.04.2017 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void nsfitspheremzc(const real_2d_array &xy, const ae_int_t npoints, const ae_int_t nx, real_1d_array &cx, double &rlo, double &rhi);
...
it in ALGLIB.
  ...
  -- ALGLIB --
     Copyright 14.04.2017 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void nsfitspherex(const real_2d_array &xy, const ae_int_t npoints, const ae_int_t nx, const ae_int_t problemtype, const double epsx, const ae_int_t aulits, const double penalty, real_1d_array &cx, double &rlo, double &rhi);
#endif
...
*************************************************************************/
ALG_LIB_DECL double spline2dcalc(const spline2dinterpolant &c, const double x, const double y);
...
Output parameters:
  ...
  -- ALGLIB PROJECT --
     Copyright 05.07.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline2ddiff(const spline2dinterpolant &c, const double x, const double y, double &f, double &fx, double &fy, double &fxy);
...
Result:
  ...
  -- ALGLIB PROJECT --
     Copyright 30.06.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline2dlintransxy(const spline2dinterpolant &c, const double ax, const double bx, const double ay, const double by);
...
Output parameters:
  ...
  -- ALGLIB PROJECT --
     Copyright 30.06.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline2dlintransf(const spline2dinterpolant &c, const double a, const double b);
...
Output parameters:
  ...
  -- ALGLIB PROJECT --
     Copyright 29.06.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline2dcopy(const spline2dinterpolant &c, spline2dinterpolant &cc);
...
Output parameters:
  ...
  -- ALGLIB routine --
     ...
     Copyright by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline2dresamplebicubic(const real_2d_array &a, const ae_int_t oldheight, const ae_int_t oldwidth, real_2d_array &b, const ae_int_t newheight, const ae_int_t newwidth);
...
Output parameters:
  ...
  -- ALGLIB routine --
     ...
     Copyright by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline2dresamplebilinear(const real_2d_array &a, const ae_int_t oldheight, const ae_int_t oldwidth, real_2d_array &b, const ae_int_t newheight, const ae_int_t newwidth);
...
*************************************************************************/
ALG_LIB_DECL void spline2dbuildbilinearv(const real_1d_array &x, const ae_int_t n, const real_1d_array &y, const ae_int_t m, const real_1d_array &f, const ae_int_t d, spline2dinterpolant &c);
...
Output parameters:
  ...
  -- ALGLIB PROJECT --
     Copyright 16.04.2012 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline2dbuildbicubicv(const real_1d_array &x, const ae_int_t n, const real_1d_array &y, const ae_int_t m, const real_1d_array &f, const ae_int_t d, spline2dinterpolant &c);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 16.04.2012 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline2dcalcvbuf(const spline2dinterpolant &c, const double x, const double y, real_1d_array &f);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB PROJECT --
     Copyright 16.04.2012 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline2dcalcv(const spline2dinterpolant &c, const double x, const double y, real_1d_array &f);
...
Result:
  ...
  -- ALGLIB PROJECT --
     Copyright 16.04.2012 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline2dunpackv(const spline2dinterpolant &c, ae_int_t &m, ae_int_t &n, ae_int_t &d, real_2d_array &tbl);
...
flexible and accepts its arguments in more convenient order.
  ...
  -- ALGLIB PROJECT --
     Copyright 05.07.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline2dbuildbilinear(const real_1d_array &x, const real_1d_array &y, const real_2d_array &f, const ae_int_t m, const ae_int_t n, spline2dinterpolant &c);
...
flexible and accepts its arguments in more convenient order.
  ...
  -- ALGLIB PROJECT --
     Copyright 05.07.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline2dbuildbicubic(const real_1d_array &x, const real_1d_array &y, const real_2d_array &f, const ae_int_t m, const ae_int_t n, spline2dinterpolant &c);
...
and accepts its arguments in more convenient order.
  ...
  -- ALGLIB PROJECT --
     Copyright 29.06.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spline2dunpack(const spline2dinterpolant &c, ae_int_t &m, ae_int_t &n, real_2d_array &tbl);
#endif
...
* s_out can be freely moved between 32-bit and 64-bit systems, little
  ...
  and vice versa.
*************************************************************************/
ALG_LIB_DECL void rbfserialize(rbfmodel &obj, std::string &s_out);


/*************************************************************************
This function unserializes data structure from string.
*************************************************************************/
ALG_LIB_DECL void rbfunserialize(const std::string &s_in, rbfmodel &obj);
...
*************************************************************************/
ALG_LIB_DECL void rbfserialize(rbfmodel &obj, std::ostream &s_out);


/*************************************************************************
This function unserializes data structure from stream.
*************************************************************************/
ALG_LIB_DECL void rbfunserialize(const std::istream &s_in, rbfmodel &obj);
...
*************************************************************************/
ALG_LIB_DECL void rbfcreate(const ae_int_t nx, const ae_int_t ny, rbfmodel &s);
...
*************************************************************************/
ALG_LIB_DECL void rbfcreatecalcbuffer(const rbfmodel &s, rbfcalcbuffer &buf);
...
*************************************************************************/
ALG_LIB_DECL void rbfsetpoints(const rbfmodel &s, const real_2d_array &xy, const ae_int_t n);
ALG_LIB_DECL void rbfsetpoints(const rbfmodel &s, const real_2d_array &xy);
...
*************************************************************************/
ALG_LIB_DECL void rbfsetpointsandscales(const rbfmodel &r, const real_2d_array &xy, const ae_int_t n, const real_1d_array &s);
ALG_LIB_DECL void rbfsetpointsandscales(const rbfmodel &r, const real_2d_array &xy, const real_1d_array &s);
...
NOTE: this   function  has   some   serialization-related  subtleties.  We
  ...
  -- ALGLIB --
     Copyright 13.12.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void rbfsetalgoqnn(const rbfmodel &s, const double q, const double z);
ALG_LIB_DECL void rbfsetalgoqnn(const rbfmodel &s);
...
*************************************************************************/
ALG_LIB_DECL void rbfsetalgomultilayer(const rbfmodel &s, const double rbase, const ae_int_t nlayers, const double lambdav);
ALG_LIB_DECL void rbfsetalgomultilayer(const rbfmodel &s, const double rbase, const ae_int_t nlayers);
...
2. Using  initial  radius  which  is  too  small.  You will get model with
  ...
  -- ALGLIB --
     Copyright 20.06.2016 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void rbfsetalgohierarchical(const rbfmodel &s, const double rbase, const ae_int_t nlayers, const double lambdans);
...
NOTE: this   function  has   some   serialization-related  subtleties.  We
  ...
  -- ALGLIB --
     Copyright 13.12.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void rbfsetlinterm(const rbfmodel &s);
...
NOTE: this   function  has   some   serialization-related  subtleties.  We
  ...
  -- ALGLIB --
     Copyright 13.12.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void rbfsetconstterm(const rbfmodel &s);
...
NOTE: this   function  has   some   serialization-related  subtleties.  We
  ...
  -- ALGLIB --
     Copyright 13.12.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void rbfsetzeroterm(const rbfmodel &s);
...
*************************************************************************/
ALG_LIB_DECL void rbfsetv2bf(const rbfmodel &s, const ae_int_t bf);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 01.02.2017 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void rbfsetv2its(const rbfmodel &s, const ae_int_t maxits);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 01.02.2017 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void rbfsetv2supportr(const rbfmodel &s, const double r);
...
unchanged.
  ...
  -- ALGLIB --
     Copyright 13.12.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void rbfbuildmodel(const rbfmodel &s, rbfreport &rep);
...
RESULT:
  ...
  -- ALGLIB --
     Copyright 13.12.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double rbfcalc1(const rbfmodel &s, const double x0);
...
RESULT:
  ...
  -- ALGLIB --
     Copyright 13.12.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double rbfcalc2(const rbfmodel &s, const double x0, const double x1);
...
RESULT:
  ...
  -- ALGLIB --
     Copyright 13.12.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double rbfcalc3(const rbfmodel &s, const double x0, const double x1, const double x2);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 13.12.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void rbfcalc(const rbfmodel &s, const real_1d_array &x, real_1d_array &y);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 13.12.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void rbfcalcbuf(const rbfmodel &s, const real_1d_array &x, real_1d_array &y);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 13.12.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void rbftscalcbuf(const rbfmodel &s, const rbfcalcbuffer &buf, const real_1d_array &x, real_1d_array &y);
...
It is superseded by rbfgridcalc2v() and  rbfgridcalc2vsubset()  functions.
  ...
  -- ALGLIB --
     Copyright 13.12.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void rbfgridcalc2(const rbfmodel &s, const real_1d_array &x0, const ae_int_t n0, const real_1d_array &x1, const ae_int_t n1, real_2d_array &y);
...
*************************************************************************/
ALG_LIB_DECL void rbfgridcalc2v(const rbfmodel &s, const real_1d_array &x0, const ae_int_t n0, const real_1d_array &x1, const ae_int_t n1, real_1d_array &y);
ALG_LIB_DECL void smp_rbfgridcalc2v(const rbfmodel &s, const real_1d_array &x0, const ae_int_t n0, const real_1d_array &x1, const ae_int_t n1, real_1d_array &y);
...
*************************************************************************/
ALG_LIB_DECL void rbfgridcalc2vsubset(const rbfmodel &s, const real_1d_array &x0, const ae_int_t n0, const real_1d_array &x1, const ae_int_t n1, const boolean_1d_array &flagy, real_1d_array &y);
ALG_LIB_DECL void smp_rbfgridcalc2vsubset(const rbfmodel &s, const real_1d_array &x0, const ae_int_t n0, const real_1d_array &x1, const ae_int_t n1, const boolean_1d_array &flagy, real_1d_array &y);
...
NOTE: if you need function values on some subset  of  regular  grid, which
  ...
  -- ALGLIB --
     Copyright 04.03.2016 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void rbfgridcalc3v(const rbfmodel &s, const real_1d_array &x0, const ae_int_t n0, const real_1d_array &x1, const ae_int_t n1, const real_1d_array &x2, const ae_int_t n2, real_1d_array &y);
ALG_LIB_DECL void smp_rbfgridcalc3v(const rbfmodel &s, const real_1d_array &x0, const ae_int_t n0, const real_1d_array &x1, const ae_int_t n1, const real_1d_array &x2, const ae_int_t n2, real_1d_array &y);
...
NOTE: this  function  is  re-entrant,  i.e.  you  may  use  same  rbfmodel
  ...
  -- ALGLIB --
     Copyright 04.03.2016 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void rbfgridcalc3vsubset(const rbfmodel &s, const real_1d_array &x0, const ae_int_t n0, const real_1d_array &x1, const ae_int_t n1, const real_1d_array &x2, const ae_int_t n2, const boolean_1d_array &flagy, real_1d_array &y);
ALG_LIB_DECL void smp_rbfgridcalc3vsubset(const rbfmodel &s, const real_1d_array &x0, const ae_int_t n0, const real_1d_array &x1, const ae_int_t n1, const real_1d_array &x2, const ae_int_t n2, const boolean_1d_array &flagy, real_1d_array &y);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 13.12.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void rbfunpack(const rbfmodel &s, ae_int_t &nx, ae_int_t &ny, real_2d_array &xwr, ae_int_t &nc, real_2d_array &v, ae_int_t &modelversion);
...
*************************************************************************/
ALG_LIB_DECL ae_int_t rbfgetmodelversion(const rbfmodel &s);
#endif
}

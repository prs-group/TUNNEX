...
*************************************************************************/
ALG_LIB_DECL void samplemoments(const real_1d_array &x, const ae_int_t n, double &mean, double &variance, double &skewness, double &kurtosis);
ALG_LIB_DECL void samplemoments(const real_1d_array &x, double &mean, double &variance, double &skewness, double &kurtosis);
...
and stored at 'Mean' variable.
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double samplemean(const real_1d_array &x, const ae_int_t n);
ALG_LIB_DECL double samplemean(const real_1d_array &x);
...
and stored at 'Variance' variable.
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double samplevariance(const real_1d_array &x, const ae_int_t n);
ALG_LIB_DECL double samplevariance(const real_1d_array &x);
...
and stored at 'Skewness' variable.
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double sampleskewness(const real_1d_array &x, const ae_int_t n);
ALG_LIB_DECL double sampleskewness(const real_1d_array &x);
...
and stored at 'Kurtosis' variable.
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double samplekurtosis(const real_1d_array &x, const ae_int_t n);
ALG_LIB_DECL double samplekurtosis(const real_1d_array &x);
...
Output parameters:
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void sampleadev(const real_1d_array &x, const ae_int_t n, double &adev);
ALG_LIB_DECL void sampleadev(const real_1d_array &x, double &adev);
...
Output parameters:
  ...
  -- ALGLIB --
     Copyright 06.09.2006 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void samplemedian(const real_1d_array &x, const ae_int_t n, double &median);
ALG_LIB_DECL void samplemedian(const real_1d_array &x, double &median);
...
*************************************************************************/
ALG_LIB_DECL void samplepercentile(const real_1d_array &x, const ae_int_t n, const double p, double &v);
ALG_LIB_DECL void samplepercentile(const real_1d_array &x, const double p, double &v);
...
*************************************************************************/
ALG_LIB_DECL double cov2(const real_1d_array &x, const real_1d_array &y, const ae_int_t n);
ALG_LIB_DECL double cov2(const real_1d_array &x, const real_1d_array &y);
...
Result:
  ...
  -- ALGLIB --
     Copyright 28.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double pearsoncorr2(const real_1d_array &x, const real_1d_array &y, const ae_int_t n);
ALG_LIB_DECL double pearsoncorr2(const real_1d_array &x, const real_1d_array &y);
...
*************************************************************************/
ALG_LIB_DECL double spearmancorr2(const real_1d_array &x, const real_1d_array &y, const ae_int_t n);
ALG_LIB_DECL double spearmancorr2(const real_1d_array &x, const real_1d_array &y);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 28.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void covm(const real_2d_array &x, const ae_int_t n, const ae_int_t m, real_2d_array &c);
ALG_LIB_DECL void smp_covm(const real_2d_array &x, const ae_int_t n, const ae_int_t m, real_2d_array &c);
ALG_LIB_DECL void covm(const real_2d_array &x, real_2d_array &c);
ALG_LIB_DECL void smp_covm(const real_2d_array &x, real_2d_array &c);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 28.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void pearsoncorrm(const real_2d_array &x, const ae_int_t n, const ae_int_t m, real_2d_array &c);
ALG_LIB_DECL void smp_pearsoncorrm(const real_2d_array &x, const ae_int_t n, const ae_int_t m, real_2d_array &c);
ALG_LIB_DECL void pearsoncorrm(const real_2d_array &x, real_2d_array &c);
ALG_LIB_DECL void smp_pearsoncorrm(const real_2d_array &x, real_2d_array &c);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 28.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spearmancorrm(const real_2d_array &x, const ae_int_t n, const ae_int_t m, real_2d_array &c);
ALG_LIB_DECL void smp_spearmancorrm(const real_2d_array &x, const ae_int_t n, const ae_int_t m, real_2d_array &c);
ALG_LIB_DECL void spearmancorrm(const real_2d_array &x, real_2d_array &c);
ALG_LIB_DECL void smp_spearmancorrm(const real_2d_array &x, real_2d_array &c);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 28.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void covm2(const real_2d_array &x, const real_2d_array &y, const ae_int_t n, const ae_int_t m1, const ae_int_t m2, real_2d_array &c);
ALG_LIB_DECL void smp_covm2(const real_2d_array &x, const real_2d_array &y, const ae_int_t n, const ae_int_t m1, const ae_int_t m2, real_2d_array &c);
ALG_LIB_DECL void covm2(const real_2d_array &x, const real_2d_array &y, real_2d_array &c);
ALG_LIB_DECL void smp_covm2(const real_2d_array &x, const real_2d_array &y, real_2d_array &c);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 28.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void pearsoncorrm2(const real_2d_array &x, const real_2d_array &y, const ae_int_t n, const ae_int_t m1, const ae_int_t m2, real_2d_array &c);
ALG_LIB_DECL void smp_pearsoncorrm2(const real_2d_array &x, const real_2d_array &y, const ae_int_t n, const ae_int_t m1, const ae_int_t m2, real_2d_array &c);
ALG_LIB_DECL void pearsoncorrm2(const real_2d_array &x, const real_2d_array &y, real_2d_array &c);
ALG_LIB_DECL void smp_pearsoncorrm2(const real_2d_array &x, const real_2d_array &y, real_2d_array &c);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 28.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spearmancorrm2(const real_2d_array &x, const real_2d_array &y, const ae_int_t n, const ae_int_t m1, const ae_int_t m2, real_2d_array &c);
ALG_LIB_DECL void smp_spearmancorrm2(const real_2d_array &x, const real_2d_array &y, const ae_int_t n, const ae_int_t m1, const ae_int_t m2, real_2d_array &c);
ALG_LIB_DECL void spearmancorrm2(const real_2d_array &x, const real_2d_array &y, real_2d_array &c);
ALG_LIB_DECL void smp_spearmancorrm2(const real_2d_array &x, const real_2d_array &y, real_2d_array &c);
...
*************************************************************************/
ALG_LIB_DECL void rankdata(const real_2d_array &xy, const ae_int_t npoints, const ae_int_t nfeatures);
ALG_LIB_DECL void smp_rankdata(const real_2d_array &xy, const ae_int_t npoints, const ae_int_t nfeatures);
ALG_LIB_DECL void rankdata(real_2d_array &xy);
ALG_LIB_DECL void smp_rankdata(real_2d_array &xy);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 18.04.2013 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void rankdatacentered(const real_2d_array &xy, const ae_int_t npoints, const ae_int_t nfeatures);
ALG_LIB_DECL void smp_rankdatacentered(const real_2d_array &xy, const ae_int_t npoints, const ae_int_t nfeatures);
ALG_LIB_DECL void rankdatacentered(real_2d_array &xy);
ALG_LIB_DECL void smp_rankdatacentered(real_2d_array &xy);
...
Obsolete function, we recommend to use PearsonCorr2().
  ...
  -- ALGLIB --
     Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double pearsoncorrelation(const real_1d_array &x, const real_1d_array &y, const ae_int_t n);
...
Obsolete function, we recommend to use SpearmanCorr2().
    ...
    Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL double spearmanrankcorrelation(const real_1d_array &x, const real_1d_array &y, const ae_int_t n);
#endif
...
*************************************************************************/
ALG_LIB_DECL void wilcoxonsignedranktest(const real_1d_array &x, const ae_int_t n, const double e, double &bothtails, double &lefttail, double &righttail);
#endif
...
approximation is used, so significance levels have about 15 exact digits.
  ...
  -- ALGLIB --
     Copyright 08.09.2006 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void onesamplesigntest(const real_1d_array &x, const ae_int_t n, const double median, double &bothtails, double &lefttail, double &righttail);
#endif
...
Output parameters:
  ...
  -- ALGLIB --
     Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void pearsoncorrelationsignificance(const double r, const ae_int_t n, double &bothtails, double &lefttail, double &righttail);
...
Output parameters:
  ...
  -- ALGLIB --
     Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void spearmanrankcorrelationsignificance(const double r, const ae_int_t n, double &bothtails, double &lefttail, double &righttail);
#endif
...
NOTE: this function correctly handles degenerate cases:
  ...
  -- ALGLIB --
     Copyright 08.09.2006 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void studentttest1(const real_1d_array &x, const ae_int_t n, const double mean, double &bothtails, double &lefttail, double &righttail);
...
*************************************************************************/
ALG_LIB_DECL void studentttest2(const real_1d_array &x, const ae_int_t n, const real_1d_array &y, const ae_int_t m, double &bothtails, double &lefttail, double &righttail);
...
NOTE: this function correctly handles degenerate cases:
  ...
  -- ALGLIB --
     Copyright 18.09.2006 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void unequalvariancettest(const real_1d_array &x, const ae_int_t n, const real_1d_array &y, const ae_int_t m, double &bothtails, double &lefttail, double &righttail);
#endif
...
NOTE: P-value approximation was  optimized  for  0.0001<=p<=0.2500.  Thus,
  ...
  -- ALGLIB --
     Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void mannwhitneyutest(const real_1d_array &x, const ae_int_t n, const real_1d_array &y, const ae_int_t m, double &bothtails, double &lefttail, double &righttail);
#endif
...
from table values.
  ...
  -- ALGLIB --
     Copyright 09.04.2007 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void jarqueberatest(const real_1d_array &x, const ae_int_t n, double &p);
#endif
...
*************************************************************************/
ALG_LIB_DECL void ftest(const real_1d_array &x, const ae_int_t n, const real_1d_array &y, const ae_int_t m, double &bothtails, double &lefttail, double &righttail);
...
Output parameters:
  ...
  -- ALGLIB --
     Copyright 19.09.2006 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void onesamplevariancetest(const real_1d_array &x, const ae_int_t n, const double variance, double &bothtails, double &lefttail, double &righttail);
#endif
}

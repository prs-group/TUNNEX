...
Class forwards
********************************************************************/
class ALG_LIB_DECL  complex;

ALG_LIB_DECL ae_int_t vlen(ae_int_t n1, ae_int_t n2);

/********************************************************************
Exception class.
********************************************************************/
#if !defined(AE_NO_EXCEPTIONS)
class ALG_LIB_DECL  ap_error
{
public:
    std::string msg;
...
const alglib::complex operator/(const double& lhs, const alglib::complex& rhs);
const alglib::complex operator/(const alglib::complex& lhs, const double& rhs);
ALG_LIB_DECL double abscomplex(const alglib::complex &z);
ALG_LIB_DECL alglib::complex conj(const alglib::complex &z);
ALG_LIB_DECL alglib::complex csqr(const alglib::complex &z);
ALG_LIB_DECL void setnworkers(alglib::ae_int_t nworkers);
...
********************************************************************/
class ALG_LIB_DECL  ae_vector_wrapper
{
public:
    //
...
class ALG_LIB_DECL  boolean_1d_array : public ae_vector_wrapper
{
public:
    boolean_1d_array();
...
class ALG_LIB_DECL  integer_1d_array : public ae_vector_wrapper
{
public:
    integer_1d_array();
...
class ALG_LIB_DECL  real_1d_array : public ae_vector_wrapper
{
public:
    real_1d_array();
...
class ALG_LIB_DECL  complex_1d_array : public ae_vector_wrapper
{
public:
    complex_1d_array();
...
class ALG_LIB_DECL  ae_matrix_wrapper
{
public:
    //
...
class ALG_LIB_DECL  boolean_2d_array : public ae_matrix_wrapper
{
public:
    boolean_2d_array();
...
class ALG_LIB_DECL  integer_2d_array : public ae_matrix_wrapper
{
public:
    integer_2d_array();
...
class ALG_LIB_DECL  real_2d_array : public ae_matrix_wrapper
{
public:
    real_2d_array();
...
class ALG_LIB_DECL  complex_2d_array : public ae_matrix_wrapper
{
public:
    complex_2d_array();
...
ALG_LIB_DECL int sign(double x);
double randomreal();
ALG_LIB_DECL ae_int_t randominteger(ae_int_t maxv);
ALG_LIB_DECL int round(double x);
ALG_LIB_DECL int trunc(double x);
ALG_LIB_DECL int ifloor(double x);
ALG_LIB_DECL int iceil(double x);
double pi();
ALG_LIB_DECL double sqr(double x);
ALG_LIB_DECL int maxint(int m1, int m2);
ALG_LIB_DECL int minint(int m1, int m2);
ALG_LIB_DECL double maxreal(double m1, double m2);
ALG_LIB_DECL double minreal(double m1, double m2);

ALG_LIB_DECL bool fp_eq(double v1, double v2);
ALG_LIB_DECL bool fp_neq(double v1, double v2);
ALG_LIB_DECL bool fp_less(double v1, double v2);
ALG_LIB_DECL bool fp_less_eq(double v1, double v2);
ALG_LIB_DECL bool fp_greater(double v1, double v2);
ALG_LIB_DECL bool fp_greater_eq(double v1, double v2);

ALG_LIB_DECL bool fp_isnan(double x);
ALG_LIB_DECL bool fp_isposinf(double x);
ALG_LIB_DECL bool fp_isneginf(double x);
ALG_LIB_DECL bool fp_isinf(double x);
ALG_LIB_DECL bool fp_isfinite(double x);

...
*************************************************************************/
class ALG_LIB_DECL  _minlbfgsstate_owner
{
public:
...
class ALG_LIB_DECL  minlbfgsstate : public _minlbfgsstate_owner
{
public:
    minlbfgsstate();
...
*************************************************************************/
class ALG_LIB_DECL  _minlbfgsreport_owner
{
public:
...
class ALG_LIB_DECL  minlbfgsreport : public _minlbfgsreport_owner
{
public:
    minlbfgsreport();
...
*************************************************************************/
class ALG_LIB_DECL  _mincgstate_owner
{
public:
    _mincgstate_owner();
...
class ALG_LIB_DECL  mincgstate : public _mincgstate_owner
{
public:
    mincgstate();
...
Other fields of this structure are not documented and should not be used!
*************************************************************************/
class ALG_LIB_DECL  _mincgreport_owner
{
public:
    _mincgreport_owner();
...
class ALG_LIB_DECL  mincgreport : public _mincgreport_owner
{
public:
    mincgreport();
...
object
*************************************************************************/
class ALG_LIB_DECL  _minbleicstate_owner
{
public:
...
class ALG_LIB_DECL  minbleicstate : public _minbleicstate_owner
{
public:
    minbleicstate();
...
*************************************************************************/
class ALG_LIB_DECL  _minbleicreport_owner
{
public:
...
class ALG_LIB_DECL  minbleicreport : public _minbleicreport_owner
{
public:
    minbleicreport();
...
object
*************************************************************************/
class ALG_LIB_DECL  _minqpstate_owner
{
public:
    _minqpstate_owner();
...
class ALG_LIB_DECL  minqpstate : public _minqpstate_owner
{
public:
    minqpstate();
...
*  7    stopping conditions are too stringent,
        ...
        X contains best point found so far.
*************************************************************************/
class ALG_LIB_DECL  _minqpreport_owner
{
public:
    _minqpreport_owner();
...
class ALG_LIB_DECL  minqpreport : public _minqpreport_owner
{
public:
    minqpreport();
...
object
*************************************************************************/
class ALG_LIB_DECL  _minnlcstate_owner
{
public:
    _minnlcstate_owner();
...
class ALG_LIB_DECL  minnlcstate : public _minnlcstate_owner
{
public:
    minnlcstate();
...
Other fields of this structure are not documented and should not be used!
*************************************************************************/
class ALG_LIB_DECL  _minnlcreport_owner
{
public:
    _minnlcreport_owner();
...
class ALG_LIB_DECL  minnlcreport : public _minnlcreport_owner
{
public:
    minnlcreport();
...
object
*************************************************************************/
class ALG_LIB_DECL  _minbcstate_owner
{
public:
    _minbcstate_owner();
...
class ALG_LIB_DECL  minbcstate : public _minbcstate_owner
{
public:
    minbcstate();
...
* DebugDX                   |X_start-X_final|
*************************************************************************/
class ALG_LIB_DECL  _minbcreport_owner
{
public:
    _minbcreport_owner();
...
class ALG_LIB_DECL  minbcreport : public _minbcreport_owner
{
public:
    minbcreport();
...
object
*************************************************************************/
class ALG_LIB_DECL  _minnsstate_owner
{
public:
    _minnsstate_owner();
...
class ALG_LIB_DECL  minnsstate : public _minnsstate_owner
{
public:
    minnsstate();
...
Other fields of this structure are not documented and should not be used!
*************************************************************************/
class ALG_LIB_DECL  _minnsreport_owner
{
public:
    _minnsreport_owner();
...
class ALG_LIB_DECL  minnsreport : public _minnsreport_owner
{
public:
    minnsreport();
...
*************************************************************************/
class ALG_LIB_DECL  _minasastate_owner
{
public:
    _minasastate_owner();
...
class ALG_LIB_DECL  minasastate : public _minasastate_owner
{
public:
    minasastate();
...
*************************************************************************/
class ALG_LIB_DECL  _minasareport_owner
{
public:
    _minasareport_owner();
...
class ALG_LIB_DECL  minasareport : public _minasareport_owner
{
public:
    minasareport();
...
to work with it.
*************************************************************************/
class ALG_LIB_DECL  _minlmstate_owner
{
public:
    _minlmstate_owner();
...
class ALG_LIB_DECL  minlmstate : public _minlmstate_owner
{
public:
    minlmstate();
...
*************************************************************************/
class ALG_LIB_DECL  _minlmreport_owner
{
public:
    _minlmreport_owner();
...
class ALG_LIB_DECL  minlmreport : public _minlmreport_owner
{
public:
    minlmreport();
...
*************************************************************************/
ALG_LIB_DECL void minlbfgscreate(const ae_int_t n, const ae_int_t m, const real_1d_array &x, minlbfgsstate &state);
ALG_LIB_DECL void minlbfgscreate(const ae_int_t m, const real_1d_array &x, minlbfgsstate &state);
...
*************************************************************************/
ALG_LIB_DECL void minlbfgscreatef(const ae_int_t n, const ae_int_t m, const real_1d_array &x, const double diffstep, minlbfgsstate &state);
ALG_LIB_DECL void minlbfgscreatef(const ae_int_t m, const real_1d_array &x, const double diffstep, minlbfgsstate &state);
...
automatic stopping criterion selection (small EpsX).
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlbfgssetcond(const minlbfgsstate &state, const double epsg, const double epsf, const double epsx, const ae_int_t maxits);
...
provided to MinLBFGSOptimize().
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlbfgssetxrep(const minlbfgsstate &state, const bool needxrep);
...
overflow) without actually calculating function value at the x+stp*d.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlbfgssetstpmax(const minlbfgsstate &state, const double stpmax);
...
*************************************************************************/
ALG_LIB_DECL void minlbfgssetscale(const minlbfgsstate &state, const real_1d_array &s);
...
*************************************************************************/
ALG_LIB_DECL void minlbfgssetprecdefault(const minlbfgsstate &state);
...
NOTE 2:  P  should  be nonsingular. Exception will be thrown otherwise.
  ...
  -- ALGLIB --
     Copyright 13.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlbfgssetpreccholesky(const minlbfgsstate &state, const real_2d_array &p, const bool isupper);
...
NOTE 3: you should pass diagonal of approximate Hessian - NOT ITS INVERSE.
  ...
  -- ALGLIB --
     Copyright 13.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlbfgssetprecdiag(const minlbfgsstate &state, const real_1d_array &d);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 13.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlbfgssetprecscale(const minlbfgsstate &state);
...
*************************************************************************/
ALG_LIB_DECL bool minlbfgsiteration(const minlbfgsstate &state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlbfgsresults(const minlbfgsstate &state, real_1d_array &x, minlbfgsreport &rep);
...
*************************************************************************/
ALG_LIB_DECL void minlbfgsresultsbuf(const minlbfgsstate &state, real_1d_array &x, minlbfgsreport &rep);
...
*************************************************************************/
ALG_LIB_DECL void minlbfgsrestartfrom(const minlbfgsstate &state, const real_1d_array &x);
...
*************************************************************************/
ALG_LIB_DECL void minlbfgsrequesttermination(const minlbfgsstate &state);
...
*************************************************************************/
ALG_LIB_DECL void minlbfgssetgradientcheck(const minlbfgsstate &state, const double teststep);
#endif
...
*************************************************************************/
ALG_LIB_DECL void mincgcreate(const ae_int_t n, const real_1d_array &x, mincgstate &state);
ALG_LIB_DECL void mincgcreate(const real_1d_array &x, mincgstate &state);
...
4. Numerical  differentiation  is   very   inefficient  -   one   gradient
  ...
  -- ALGLIB --
     Copyright 16.05.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void mincgcreatef(const ae_int_t n, const real_1d_array &x, const double diffstep, mincgstate &state);
ALG_LIB_DECL void mincgcreatef(const real_1d_array &x, const double diffstep, mincgstate &state);
...
automatic stopping criterion selection (small EpsX).
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void mincgsetcond(const mincgstate &state, const double epsg, const double epsf, const double epsx, const ae_int_t maxits);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 14.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void mincgsetscale(const mincgstate &state, const real_1d_array &s);
...
provided to MinCGOptimize().
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void mincgsetxrep(const mincgstate &state, const bool needxrep);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void mincgsetcgtype(const mincgstate &state, const ae_int_t cgtype);
...
overflow) without actually calculating function value at the x+stp*d.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void mincgsetstpmax(const mincgstate &state, const double stpmax);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 30.07.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void mincgsuggeststep(const mincgstate &state, const double stp);
...
iterations.
  ...
  -- ALGLIB --
     Copyright 13.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void mincgsetprecdefault(const mincgstate &state);
...
NOTE 3: you should pass diagonal of approximate Hessian - NOT ITS INVERSE.
  ...
  -- ALGLIB --
     Copyright 13.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void mincgsetprecdiag(const mincgstate &state, const real_1d_array &d);
...
iterations.
  ...
  -- ALGLIB --
     Copyright 13.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void mincgsetprecscale(const mincgstate &state);
...
See below for functions which provide better documented API
*************************************************************************/
ALG_LIB_DECL bool mincgiteration(const mincgstate &state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 20.04.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void mincgresults(const mincgstate &state, real_1d_array &x, mincgreport &rep);
...
where array reallocation penalty is too large to be ignored.
  ...
  -- ALGLIB --
     Copyright 20.04.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void mincgresultsbuf(const mincgstate &state, real_1d_array &x, mincgreport &rep);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 30.07.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void mincgrestartfrom(const mincgstate &state, const real_1d_array &x);
...
NOTE: multiple calls to this function are possible. First call is counted,
  ...
  -- ALGLIB --
     Copyright 08.10.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void mincgrequesttermination(const mincgstate &state);
...
*************************************************************************/
ALG_LIB_DECL void mincgsetgradientcheck(const mincgstate &state, const double teststep);
#endif
...
*************************************************************************/
ALG_LIB_DECL void minbleiccreate(const ae_int_t n, const real_1d_array &x, minbleicstate &state);
ALG_LIB_DECL void minbleiccreate(const real_1d_array &x, minbleicstate &state);
...
4. Numerical  differentiation  is   very   inefficient  -   one   gradient
  ...
  -- ALGLIB --
     Copyright 16.05.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbleiccreatef(const ae_int_t n, const real_1d_array &x, const double diffstep, minbleicstate &state);
ALG_LIB_DECL void minbleiccreatef(const real_1d_array &x, const double diffstep, minbleicstate &state);
...
* function is evaluated only INSIDE area specified by  bound  constraints,
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbleicsetbc(const minbleicstate &state, const real_1d_array &bndl, const real_1d_array &bndu);
...
solution and in all intermediate points).
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbleicsetlc(const minbleicstate &state, const real_2d_array &c, const integer_1d_array &ct, const ae_int_t k);
ALG_LIB_DECL void minbleicsetlc(const minbleicstate &state, const real_2d_array &c, const integer_1d_array &ct);
...
NOTE: when SetCond() called with non-zero MaxIts, BLEIC solver may perform
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbleicsetcond(const minbleicstate &state, const double epsg, const double epsf, const double epsx, const ae_int_t maxits);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 14.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbleicsetscale(const minbleicstate &state, const real_1d_array &s);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 13.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbleicsetprecdefault(const minbleicstate &state);
...
NOTE 2: you should pass diagonal of approximate Hessian - NOT ITS INVERSE.
  ...
  -- ALGLIB --
     Copyright 13.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbleicsetprecdiag(const minbleicstate &state, const real_1d_array &d);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 13.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbleicsetprecscale(const minbleicstate &state);
...
provided to MinBLEICOptimize().
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbleicsetxrep(const minbleicstate &state, const bool needxrep);
...
overflow) without actually calculating function value at the x+stp*d.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbleicsetstpmax(const minbleicstate &state, const double stpmax);
...
See below for functions which provide better documented API
*************************************************************************/
ALG_LIB_DECL bool minbleiciteration(const minbleicstate &state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbleicresults(const minbleicstate &state, real_1d_array &x, minbleicreport &rep);
...
where array reallocation penalty is too large to be ignored.
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbleicresultsbuf(const minbleicstate &state, real_1d_array &x, minbleicreport &rep);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbleicrestartfrom(const minbleicstate &state, const real_1d_array &x);
...
NOTE: multiple calls to this function are possible. First call is counted,
  ...
  -- ALGLIB --
     Copyright 08.10.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbleicrequesttermination(const minbleicstate &state);
...
*************************************************************************/
ALG_LIB_DECL void minbleicsetgradientcheck(const minbleicstate &state, const double teststep);
#endif
...
*************************************************************************/
ALG_LIB_DECL void minqpcreate(const ae_int_t n, minqpstate &state);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 11.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minqpsetlinearterm(const minqpstate &state, const real_1d_array &b);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 11.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minqpsetquadraticterm(const minqpstate &state, const real_2d_array &a, const bool isupper);
ALG_LIB_DECL void minqpsetquadraticterm(const minqpstate &state, const real_2d_array &a);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 11.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minqpsetquadratictermsparse(const minqpstate &state, const sparsematrix &a, const bool isupper);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 11.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minqpsetstartingpoint(const minqpstate &state, const real_1d_array &x);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 11.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minqpsetorigin(const minqpstate &state, const real_1d_array &xorigin);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 14.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minqpsetscale(const minqpstate &state, const real_1d_array &s);
...
*************************************************************************/
ALG_LIB_DECL void minqpsetscaleautodiag(const minqpstate &state);
...
DEPRECATED   DEPRECATED   DEPRECATED   DEPRECATED   DEPRECATED  DEPRECATED
  ...
  -- ALGLIB --
     Copyright 11.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minqpsetalgocholesky(const minqpstate &state);
...
length, but it may change in the future versions of ALGLIB).
  ...
  -- ALGLIB --
     Copyright 11.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minqpsetalgobleic(const minqpstate &state, const double epsg, const double epsf, const double epsx, const ae_int_t maxits);
...
*************************************************************************/
ALG_LIB_DECL void minqpsetalgodenseaul(const minqpstate &state, const double epsx, const double rho, const ae_int_t itscnt);
...
*************************************************************************/
ALG_LIB_DECL void minqpsetalgoquickqp(const minqpstate &state, const double epsg, const double epsf, const double epsx, const ae_int_t maxouterits, const bool usenewton);
...
variable will be "frozen" at X[i]=BndL[i]=BndU[i].
  ...
  -- ALGLIB --
     Copyright 11.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minqpsetbc(const minqpstate &state, const real_1d_array &bndl, const real_1d_array &bndu);
...
*************************************************************************/
ALG_LIB_DECL void minqpsetlc(const minqpstate &state, const real_2d_array &c, const integer_1d_array &ct, const ae_int_t k);
ALG_LIB_DECL void minqpsetlc(const minqpstate &state, const real_2d_array &c, const integer_1d_array &ct);
...
*************************************************************************/
ALG_LIB_DECL void minqpsetlcsparse(const minqpstate &state, const sparsematrix &c, const integer_1d_array &ct, const ae_int_t k);
...
NOTE 1: linear (non-bound) constraints are satisfied only approximately  -
  ...
  -- ALGLIB --
     Copyright 22.08.2016 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minqpsetlcmixed(const minqpstate &state, const real_2d_array &densec, const integer_1d_array &densect, const ae_int_t densek, const sparsematrix &sparsec, const integer_1d_array &sparsect, const ae_int_t sparsek);
...
*************************************************************************/
ALG_LIB_DECL void minqpoptimize(const minqpstate &state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 11.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minqpresults(const minqpstate &state, real_1d_array &x, minqpreport &rep);
...
where array reallocation penalty is too large to be ignored.
  ...
  -- ALGLIB --
     Copyright 11.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minqpresultsbuf(const minqpstate &state, real_1d_array &x, minqpreport &rep);
#endif
...
*************************************************************************/
ALG_LIB_DECL void minnlccreate(const ae_int_t n, const real_1d_array &x, minnlcstate &state);
ALG_LIB_DECL void minnlccreate(const real_1d_array &x, minnlcstate &state);
...
4. Numerical  differentiation  is   very   inefficient  -   one   gradient
  ...
  -- ALGLIB --
     Copyright 06.06.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnlccreatef(const ae_int_t n, const real_1d_array &x, const double diffstep, minnlcstate &state);
ALG_LIB_DECL void minnlccreatef(const real_1d_array &x, const double diffstep, minnlcstate &state);
...
NOTE 2:  when you solve your problem  with  augmented  Lagrangian  solver,
  ...
  -- ALGLIB --
     Copyright 06.06.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnlcsetbc(const minnlcstate &state, const real_1d_array &bndl, const real_1d_array &bndu);
...
NOTE 1: when you solve your problem  with  augmented  Lagrangian   solver,
  ...
  -- ALGLIB --
     Copyright 06.06.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnlcsetlc(const minnlcstate &state, const real_2d_array &c, const integer_1d_array &ct, const ae_int_t k);
ALG_LIB_DECL void minnlcsetlc(const minnlcstate &state, const real_2d_array &c, const integer_1d_array &ct);
...
NOTE 2: algorithm scales variables  according  to   scale   specified   by
  ...
  -- ALGLIB --
     Copyright 06.06.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnlcsetnlc(const minnlcstate &state, const ae_int_t nlec, const ae_int_t nlic);
...
to automatic stopping criterion selection.
  ...
  -- ALGLIB --
     Copyright 06.06.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnlcsetcond(const minnlcstate &state, const double epsg, const double epsf, const double epsx, const ae_int_t maxits);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 06.06.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnlcsetscale(const minnlcstate &state, const real_1d_array &s);
...
*************************************************************************/
ALG_LIB_DECL void minnlcsetprecinexact(const minnlcstate &state);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 26.09.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnlcsetprecexactlowrank(const minnlcstate &state, const ae_int_t updatefreq);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 26.09.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnlcsetprecexactrobust(const minnlcstate &state, const ae_int_t updatefreq);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 26.09.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnlcsetprecnone(const minnlcstate &state);
...
overflow) without actually calculating function value at the x+stp*d.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnlcsetstpmax(const minnlcstate &state, const double stpmax);
...
destabilize algorithm.
  ...
  -- ALGLIB --
     Copyright 06.06.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnlcsetalgoaul(const minnlcstate &state, const double rho, const ae_int_t itscnt);
...
NOTE: algorithm passes two parameters to rep() callback  -  current  point
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnlcsetxrep(const minnlcstate &state, const bool needxrep);
...
See below for functions which provide better documented API
*************************************************************************/
ALG_LIB_DECL bool minnlciteration(const minnlcstate &state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 06.06.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnlcresults(const minnlcstate &state, real_1d_array &x, minnlcreport &rep);
...
where array reallocation penalty is too large to be ignored.
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnlcresultsbuf(const minnlcstate &state, real_1d_array &x, minnlcreport &rep);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnlcrestartfrom(const minnlcstate &state, const real_1d_array &x);
...
*************************************************************************/
ALG_LIB_DECL void minnlcsetgradientcheck(const minnlcstate &state, const double teststep);
#endif
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbccreate(const ae_int_t n, const real_1d_array &x, minbcstate &state);
ALG_LIB_DECL void minbccreate(const real_1d_array &x, minbcstate &state);
...
4. Numerical  differentiation  is   very   inefficient  -   one   gradient
  ...
  -- ALGLIB --
     Copyright 16.05.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbccreatef(const ae_int_t n, const real_1d_array &x, const double diffstep, minbcstate &state);
ALG_LIB_DECL void minbccreatef(const real_1d_array &x, const double diffstep, minbcstate &state);
...
* function is evaluated only INSIDE area specified by  bound  constraints,
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbcsetbc(const minbcstate &state, const real_1d_array &bndl, const real_1d_array &bndu);
...
NOTE: when SetCond() called with non-zero MaxIts, BC solver may perform
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbcsetcond(const minbcstate &state, const double epsg, const double epsf, const double epsx, const ae_int_t maxits);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 14.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbcsetscale(const minbcstate &state, const real_1d_array &s);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 13.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbcsetprecdefault(const minbcstate &state);
...
NOTE 2: you should pass diagonal of approximate Hessian - NOT ITS INVERSE.
  ...
  -- ALGLIB --
     Copyright 13.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbcsetprecdiag(const minbcstate &state, const real_1d_array &d);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 13.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbcsetprecscale(const minbcstate &state);
...
provided to MinBCOptimize().
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbcsetxrep(const minbcstate &state, const bool needxrep);
...
overflow) without actually calculating function value at the x+stp*d.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbcsetstpmax(const minbcstate &state, const double stpmax);
...
See below for functions which provide better documented API
*************************************************************************/
ALG_LIB_DECL bool minbciteration(const minbcstate &state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbcresults(const minbcstate &state, real_1d_array &x, minbcreport &rep);
...
where array reallocation penalty is too large to be ignored.
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbcresultsbuf(const minbcstate &state, real_1d_array &x, minbcreport &rep);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbcrestartfrom(const minbcstate &state, const real_1d_array &x);
...
NOTE: multiple calls to this function are possible. First call is counted,
  ...
  -- ALGLIB --
     Copyright 08.10.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbcrequesttermination(const minbcstate &state);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 15.06.2012 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbcsetgradientcheck(const minbcstate &state, const double teststep);
#endif
...
*************************************************************************/
ALG_LIB_DECL void minnscreate(const ae_int_t n, const real_1d_array &x, minnsstate &state);
ALG_LIB_DECL void minnscreate(const real_1d_array &x, minnsstate &state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 18.05.2015 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnscreatef(const ae_int_t n, const real_1d_array &x, const double diffstep, minnsstate &state);
ALG_LIB_DECL void minnscreatef(const real_1d_array &x, const double diffstep, minnsstate &state);
...
* function is evaluated only INSIDE area specified by  bound  constraints,
  ...
  -- ALGLIB --
     Copyright 18.05.2015 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnssetbc(const minnsstate &state, const real_1d_array &bndl, const real_1d_array &bndu);
...
solution and in all intermediate points).
  ...
  -- ALGLIB --
     Copyright 18.05.2015 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnssetlc(const minnsstate &state, const real_2d_array &c, const integer_1d_array &ct, const ae_int_t k);
ALG_LIB_DECL void minnssetlc(const minnsstate &state, const real_2d_array &c, const integer_1d_array &ct);
...
NOTE 3: nonlinear constraints are always hard to handle,  no  matter  what
  ...
  -- ALGLIB --
     Copyright 18.05.2015 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnssetnlc(const minnsstate &state, const ae_int_t nlec, const ae_int_t nlic);
...
choice in production code.
  ...
  -- ALGLIB --
     Copyright 18.05.2015 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnssetcond(const minnsstate &state, const double epsx, const ae_int_t maxits);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 18.05.2015 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnssetscale(const minnsstate &state, const real_1d_array &s);
...
* penalty coefficient for  linear  constraints  is  chosen  automatically;
  ...
  -- ALGLIB --
     Copyright 18.05.2015 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnssetalgoags(const minnsstate &state, const double radius, const double penalty);
...
provided to minnsoptimize().
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnssetxrep(const minnsstate &state, const bool needxrep);
...
NOTE: multiple calls to this function are possible. First call is counted,
  ...
  -- ALGLIB --
     Copyright 18.05.2015 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnsrequesttermination(const minnsstate &state);
...
See below for functions which provide better documented API
*************************************************************************/
ALG_LIB_DECL bool minnsiteration(const minnsstate &state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 18.05.2015 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnsresults(const minnsstate &state, real_1d_array &x, minnsreport &rep);
...
where array reallocation penalty is too large to be ignored.
  ...
  -- ALGLIB --
     Copyright 18.05.2015 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnsresultsbuf(const minnsstate &state, real_1d_array &x, minnsreport &rep);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 18.05.2015 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minnsrestartfrom(const minnsstate &state, const real_1d_array &x);
#endif
...
Obsolete function, use MinLBFGSSetPrecDefault() instead.
  ...
  -- ALGLIB --
     Copyright 13.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlbfgssetdefaultpreconditioner(const minlbfgsstate &state);
...
Obsolete function, use MinLBFGSSetCholeskyPreconditioner() instead.
  ...
  -- ALGLIB --
     Copyright 13.10.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlbfgssetcholeskypreconditioner(const minlbfgsstate &state, const real_2d_array &p, const bool isupper);
...
optimizer. It does nothing in the current version of BLEIC.
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbleicsetbarrierwidth(const minbleicstate &state, const double mu);
...
optimizer. It does nothing in the current version of BLEIC.
  ...
  -- ALGLIB --
     Copyright 28.11.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minbleicsetbarrierdecay(const minbleicstate &state, const double mudecay);
...
Was replaced by MinBLEIC subpackage.
  ...
  -- ALGLIB --
     Copyright 25.03.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minasacreate(const ae_int_t n, const real_1d_array &x, const real_1d_array &bndl, const real_1d_array &bndu, minasastate &state);
ALG_LIB_DECL void minasacreate(const real_1d_array &x, const real_1d_array &bndl, const real_1d_array &bndu, minasastate &state);
...
Was replaced by MinBLEIC subpackage.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minasasetcond(const minasastate &state, const double epsg, const double epsf, const double epsx, const ae_int_t maxits);
...
Was replaced by MinBLEIC subpackage.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minasasetxrep(const minasastate &state, const bool needxrep);
...
Was replaced by MinBLEIC subpackage.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minasasetalgorithm(const minasastate &state, const ae_int_t algotype);
...
Was replaced by MinBLEIC subpackage.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minasasetstpmax(const minasastate &state, const double stpmax);
...
See below for functions which provide better documented API
*************************************************************************/
ALG_LIB_DECL bool minasaiteration(const minasastate &state);
...
Was replaced by MinBLEIC subpackage.
  ...
  -- ALGLIB --
     Copyright 20.03.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minasaresults(const minasastate &state, real_1d_array &x, minasareport &rep);
...
Was replaced by MinBLEIC subpackage.
  ...
  -- ALGLIB --
     Copyright 20.03.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minasaresultsbuf(const minasastate &state, real_1d_array &x, minasareport &rep);
...
Was replaced by MinBLEIC subpackage.
  ...
  -- ALGLIB --
     Copyright 30.07.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minasarestartfrom(const minasastate &state, const real_1d_array &x, const real_1d_array &bndl, const real_1d_array &bndu);
#endif
...
*************************************************************************/
ALG_LIB_DECL void minlmcreatevj(const ae_int_t n, const ae_int_t m, const real_1d_array &x, minlmstate &state);
ALG_LIB_DECL void minlmcreatevj(const ae_int_t m, const real_1d_array &x, minlmstate &state);
...
2. if target function contains exp() or other fast growing functions,  and
  ...
  -- ALGLIB --
     Copyright 30.03.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlmcreatev(const ae_int_t n, const ae_int_t m, const real_1d_array &x, const double diffstep, minlmstate &state);
ALG_LIB_DECL void minlmcreatev(const ae_int_t m, const real_1d_array &x, const double diffstep, minlmstate &state);
...
2. if target function contains exp() or other fast growing functions,  and
  ...
  -- ALGLIB --
     Copyright 30.03.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlmcreatefgh(const ae_int_t n, const real_1d_array &x, minlmstate &state);
ALG_LIB_DECL void minlmcreatefgh(const real_1d_array &x, minlmstate &state);
...
NOTE: it is not recommended to set large EpsX (say, 0.001). Because LM  is
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlmsetcond(const minlmstate &state, const double epsx, const ae_int_t maxits);
...
iterations are reported.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlmsetxrep(const minlmstate &state, const bool needxrep);
...
with limits on step size.
  ...
  -- ALGLIB --
     Copyright 02.04.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlmsetstpmax(const minlmstate &state, const double stpmax);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 14.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlmsetscale(const minlmstate &state, const real_1d_array &s);
...
* function is evaluated only INSIDE area specified by bound constraints
  ...
  -- ALGLIB --
     Copyright 14.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlmsetbc(const minlmstate &state, const real_1d_array &bndl, const real_1d_array &bndu);
...
NOTE: general linear constraints  add  significant  overhead  to  solution
  ...
  -- ALGLIB --
     Copyright 14.01.2011 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlmsetlc(const minlmstate &state, const real_2d_array &c, const integer_1d_array &ct, const ae_int_t k);
ALG_LIB_DECL void minlmsetlc(const minlmstate &state, const real_2d_array &c, const integer_1d_array &ct);
...
*************************************************************************/
ALG_LIB_DECL void minlmsetacctype(const minlmstate &state, const ae_int_t acctype);
...
See below for functions which provide better documented API
*************************************************************************/
ALG_LIB_DECL bool minlmiteration(const minlmstate &state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 10.03.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlmresults(const minlmstate &state, real_1d_array &x, minlmreport &rep);
...
where array reallocation penalty is too large to be ignored.
  ...
  -- ALGLIB --
     Copyright 10.03.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlmresultsbuf(const minlmstate &state, real_1d_array &x, minlmreport &rep);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 30.07.2010 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlmrestartfrom(const minlmstate &state, const real_1d_array &x);
...
NOTE: multiple calls to this function are possible. First call is counted,
  ...
  -- ALGLIB --
     Copyright 08.10.2014 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlmrequesttermination(const minlmstate &state);
...
Since ALGLIB 3.3 it is equivalent to MinLMCreateVJ().
  ...
  -- ALGLIB --
     Copyright 30.03.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlmcreatevgj(const ae_int_t n, const ae_int_t m, const real_1d_array &x, minlmstate &state);
ALG_LIB_DECL void minlmcreatevgj(const ae_int_t m, const real_1d_array &x, minlmstate &state);
...
Since ALGLIB 3.3 it is equivalent to MinLMCreateFJ().
  ...
  -- ALGLIB --
     Copyright 30.03.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlmcreatefgj(const ae_int_t n, const ae_int_t m, const real_1d_array &x, minlmstate &state);
ALG_LIB_DECL void minlmcreatefgj(const ae_int_t m, const real_1d_array &x, minlmstate &state);
...
provides similar, but more consistent and feature-rich interface.
  ...
  -- ALGLIB --
     Copyright 30.03.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlmcreatefj(const ae_int_t n, const ae_int_t m, const real_1d_array &x, minlmstate &state);
ALG_LIB_DECL void minlmcreatefj(const ae_int_t m, const real_1d_array &x, minlmstate &state);
...
INPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 15.06.2012 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void minlmsetgradientcheck(const minlmstate &state, const double teststep);
#endif
}

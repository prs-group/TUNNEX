...
*************************************************************************/
class ALG_LIB_DECL  _odesolverstate_owner
{
public:
...
class ALG_LIB_DECL  odesolverstate : public _odesolverstate_owner
{
public:
    odesolverstate();
...
*************************************************************************/
class ALG_LIB_DECL  _odesolverreport_owner
{
public:
...
class ALG_LIB_DECL  odesolverreport : public _odesolverreport_owner
{
public:
    odesolverreport();
...
*************************************************************************/
ALG_LIB_DECL void odesolverrkck(const real_1d_array &y, const ae_int_t n, const real_1d_array &x, const ae_int_t m, const double eps, const double h, odesolverstate &state);
ALG_LIB_DECL void odesolverrkck(const real_1d_array &y, const real_1d_array &x, const double eps, const double h, odesolverstate &state);
...
*************************************************************************/
ALG_LIB_DECL bool odesolveriteration(const odesolverstate &state);
...
OUTPUT PARAMETERS:
  ...
  -- ALGLIB --
     Copyright 01.09.2009 by Bochkanov Sergey
*************************************************************************/
ALG_LIB_DECL void odesolverresults(const odesolverstate &state, ae_int_t &m, real_1d_array &xtbl, real_2d_array &ytbl, odesolverreport &rep);
#endif
}

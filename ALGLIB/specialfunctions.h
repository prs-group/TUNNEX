...
*************************************************************************/
ALG_LIB_DECL double gammafunction(const double x);
...
Translated to AlgoPascal by Bochkanov Sergey (2005, 2006, 2007).
*************************************************************************/
ALG_LIB_DECL double lngamma(const double x, double &sgngam);
#endif
...
*************************************************************************/
ALG_LIB_DECL double errorfunction(const double x);
...
Copyright 1984, 1987, 1988, 1992, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double errorfunctionc(const double x);
...
Copyright 1984, 1987, 1988, 1992, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double normaldistribution(const double x);
...
Copyright 1984, 1987, 1988, 1992, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double inverf(const double e);
...
Copyright 1984, 1987, 1988, 1992, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double invnormaldistribution(const double y0);
#endif
...
*************************************************************************/
ALG_LIB_DECL double incompletegamma(const double a, const double x);
...
Copyright 1985, 1987, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double incompletegammac(const double a, const double x);
...
*************************************************************************/
ALG_LIB_DECL double invincompletegammac(const double a, const double y0);
#endif
...
*************************************************************************/
ALG_LIB_DECL double ellipticintegralk(const double m);
...
Copyright 1984, 1987, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double ellipticintegralkhighprecision(const double m1);
...
Copyright 1984, 1987, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double incompleteellipticintegralk(const double phi, const double m);
...
*************************************************************************/
ALG_LIB_DECL double ellipticintegrale(const double m);
...
*************************************************************************/
ALG_LIB_DECL double incompleteellipticintegrale(const double phi, const double m);
#endif
...
*************************************************************************/
ALG_LIB_DECL double hermitecalculate(const ae_int_t n, const double x);
...
*************************************************************************/
ALG_LIB_DECL double hermitesum(const real_1d_array &c, const ae_int_t n, const double x);
...
Output parameters:
    C   -   coefficients
*************************************************************************/
ALG_LIB_DECL void hermitecoefficients(const ae_int_t n, real_1d_array &c);
#endif
...
Copyright 1984, 1987, 1989, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double dawsonintegral(const double x);
#endif
...
*************************************************************************/
ALG_LIB_DECL void sinecosineintegrals(const double x, double &si, double &ci);
...
Copyright 1984, 1987, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL void hyperbolicsinecosineintegrals(const double x, double &shi, double &chi);
#endif
...
Copyright 1984, 1987, 1995, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double poissondistribution(const ae_int_t k, const double m);
...
Copyright 1984, 1987, 1995, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double poissoncdistribution(const ae_int_t k, const double m);
...
Copyright 1984, 1987, 1995, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double invpoissondistribution(const ae_int_t k, const double y);
#endif
...
Copyright 1984, 1987, 1989, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double besselj0(const double x);
...
Copyright 1984, 1987, 1989, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double besselj1(const double x);
...
Copyright 1984, 1987, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double besseljn(const ae_int_t n, const double x);
...
Copyright 1984, 1987, 1989, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double bessely0(const double x);
...
Copyright 1984, 1987, 1989, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double bessely1(const double x);
...
Copyright 1984, 1987, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double besselyn(const ae_int_t n, const double x);
...
Copyright 1984, 1987, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double besseli0(const double x);
...
Copyright 1985, 1987, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double besseli1(const double x);
...
Copyright 1984, 1987, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double besselk0(const double x);
...
Copyright 1984, 1987, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double besselk1(const double x);
...
*************************************************************************/
ALG_LIB_DECL double besselkn(const ae_int_t nn, const double x);
#endif
...
*************************************************************************/
ALG_LIB_DECL double incompletebeta(const double a, const double b, const double x);
...
*************************************************************************/
ALG_LIB_DECL double invincompletebeta(const double a, const double b, const double y);
#endif
...
Copyright 1984, 1987, 1995, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double fdistribution(const ae_int_t a, const ae_int_t b, const double x);
...
Copyright 1984, 1987, 1995, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double fcdistribution(const ae_int_t a, const ae_int_t b, const double x);
...
Copyright 1984, 1987, 1995, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double invfdistribution(const ae_int_t a, const ae_int_t b, const double y);
#endif
...
Copyright 1984, 1987, 1989, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL void fresnelintegral(const double x, double &c, double &s);
#endif
...
Copyright 1984, 1987, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL void jacobianellipticfunctions(const double u, const double m, double &sn, double &cn, double &dn, double &ph);
#endif
...
*************************************************************************/
ALG_LIB_DECL double psi(const double x);
#endif
...
*************************************************************************/
ALG_LIB_DECL double exponentialintegralei(const double x);
...
*************************************************************************/
ALG_LIB_DECL double exponentialintegralen(const double x, const ae_int_t n);
#endif
...
*************************************************************************/
ALG_LIB_DECL double laguerrecalculate(const ae_int_t n, const double x);
...
*************************************************************************/
ALG_LIB_DECL double laguerresum(const real_1d_array &c, const ae_int_t n, const double x);
...
Output parameters:
    C   -   coefficients
*************************************************************************/
ALG_LIB_DECL void laguerrecoefficients(const ae_int_t n, real_1d_array &c);
#endif
...
Copyright 1984, 1987, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double chisquaredistribution(const double v, const double x);
...
Copyright 1984, 1987, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double chisquarecdistribution(const double v, const double x);
...
Copyright 1984, 1987, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double invchisquaredistribution(const double v, const double y);
#endif
...
*************************************************************************/
ALG_LIB_DECL double legendrecalculate(const ae_int_t n, const double x);
...
*************************************************************************/
ALG_LIB_DECL double legendresum(const real_1d_array &c, const ae_int_t n, const double x);
...
Output parameters:
    C   -   coefficients
*************************************************************************/
ALG_LIB_DECL void legendrecoefficients(const ae_int_t n, real_1d_array &c);
#endif
...
*************************************************************************/
ALG_LIB_DECL double beta(const double a, const double b);
#endif
...
*************************************************************************/
ALG_LIB_DECL double chebyshevcalculate(const ae_int_t r, const ae_int_t n, const double x);
...
Result:
    the value of the Chebyshev polynomial at x
*************************************************************************/
ALG_LIB_DECL double chebyshevsum(const real_1d_array &c, const ae_int_t r, const ae_int_t n, const double x);
...
Output parameters:
    C   -   coefficients
*************************************************************************/
ALG_LIB_DECL void chebyshevcoefficients(const ae_int_t n, real_1d_array &c);
...
*************************************************************************/
ALG_LIB_DECL void fromchebyshev(const real_1d_array &a, const ae_int_t n, real_1d_array &b);
#endif
...
Copyright 1984, 1987, 1995, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double studenttdistribution(const ae_int_t k, const double t);
...
Copyright 1984, 1987, 1995, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double invstudenttdistribution(const ae_int_t k, const double p);
#endif
...
Copyright 1984, 1987, 1995, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double binomialdistribution(const ae_int_t k, const ae_int_t n, const double p);
...
Copyright 1984, 1987, 1995, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double binomialcdistribution(const ae_int_t k, const ae_int_t n, const double p);
...
Copyright 1984, 1987, 1995, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL double invbinomialdistribution(const ae_int_t k, const ae_int_t n, const double y);
#endif
...
Copyright 1984, 1987, 1989, 2000 by Stephen L. Moshier
*************************************************************************/
ALG_LIB_DECL void airy(const double x, double &ai, double &aip, double &bi, double &bip);
#endif
}
